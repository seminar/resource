...
<title>popen函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">popen（建立管道I/O）<br>
	相关函数 pipe，mkfifo，pclose，fork，system，fopen<br>
	表头文件 #include&lt;stdio.h&gt;<br>
	定义函数 FILE * popen( const char * command,const char * type);<br>
	函数说明 popen()会调用fork()产生子进程，然后从子进程中调用/bin/sh -c<br>
	...
	用，除了fclose()以外。<br>
	返回值 若成功则返回文件指针，否则返回NULL，错误原因存于errno中。<br>
	错误代码 EINVAL参数type不合法。<br>
	注意事项 在编写具SUID/SGID权限的程序时请尽量避免使用popen()，popen()<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="popen.php#" class="bds_more" data-cmd="more"></a>
	<a href="popen.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="popen.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="popen.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="popen.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="popen.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
