...
<title>pause函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">pause（让进程暂停直到信号出现）<br>
	相关函数 kill，signal，sleep<br>
	表头文件 #include&lt;unistd.h&gt;<br>
	定义函数 int pause(void);<br>
	函数说明 pause()会令目前的进程暂停（进入睡眠状态），直到被信号(signal)所中断。<br>
	返回值 只返回-1。<br>
	错误代码 EINTR 有信号到达中断了此函数。</td>
	</tr>
</table>
　</td>
    <td background="../img_css/frame11.gif" width="14">　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="pause.php#" class="bds_more" data-cmd="more"></a>
	<a href="pause.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="pause.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="pause.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="pause.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="pause.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
