...
<title>sleep函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">sleep（让进程暂停执行一段时间）<br>
	相关函数 signal，alarm<br>
	表头文件 #include&lt;unistd.h&gt;<br>
	定义函数 unsigned int sleep(unsigned int seconds);<br>
	函数说明 sleep()会令目前的进程暂停，直到达到参数seconds 所指定的时间，或是被信号所中断。<br>
	返回值 若进程暂停到参数seconds 所指定的时间则返回0，若有信号中断则<br>
	返回剩余秒数。</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="sleep.php#" class="bds_more" data-cmd="more"></a>
	<a href="sleep.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="sleep.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="sleep.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="sleep.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="sleep.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
