...
<title>alarm函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">alarm（设置信号传送闹钟）<br>
	相关函数 signal，sleep<br>
	表头文件 #include&lt;unistd.h&gt;<br>
	定义函数 unsigned int alarm(unsigned int seconds);<br>
	函数说明 alarm()用来设置信号SIGALRM在经过参数seconds指定的秒数后传送给目前的进程。如果参数seconds 
	为0，则之前设置的闹钟会被取消，并将剩下的时间返回。<br>
	返回值 返回之前闹钟的剩余秒数，如果之前未设闹钟则返回0。</td>
	</tr>
</table>
　</td>
    <td background="../img_css/frame11.gif" width="14">　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="alarm.php#" class="bds_more" data-cmd="more"></a>
	<a href="alarm.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="alarm.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="alarm.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="alarm.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="alarm.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
