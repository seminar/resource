...
<title>sigprocmask函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">sigprocmask（查询或设置信号遮罩）<br>
	相关函数 signal，sigaction，sigpending，sigsuspend<br>
	表头文件 #include&lt;signal.h&gt;<br>
	定义函数 int sigprocmask(int how,const sigset_t *set,sigset_t *<br>
	oldset);<br>
	函数说明 sigprocmask()可以用来改变目前的信号遮罩，其操作依参数how来决定<br>
	SIG_BLOCK 新的信号遮罩由目前的信号遮罩和参数set 指定的信号<br>
	遮罩作联集<br>
	SIG_UNBLOCK 将目前的信号遮罩删除掉参数set指定的信号遮罩<br>
	SIG_SETMASK 将目前的信号遮罩设成参数set指定的信号遮罩。<br>
	如果参数oldset不是NULL指针，那么目前的信号遮罩会由此指针返<br>
	回。<br>
	返回值 执行成功则返回0，如果有错误则返回-1。<br>
	错误代码 EFAULT 参数set，oldset指针地址无法存取。<br>
	EINTR 此调用被中断</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="sigprocmask.php#" class="bds_more" data-cmd="more"></a>
	<a href="sigprocmask.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="sigprocmask.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="sigprocmask.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="sigprocmask.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="sigprocmask.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
