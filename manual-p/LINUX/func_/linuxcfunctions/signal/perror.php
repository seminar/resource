...
<title>perror函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">perror（打印出错误原因信息字符串）<br>
	相关函数 strerror<br>
	表头文件 #include&lt;stdio.h&gt;<br>
	定义函数 void perror(const char *s);<br>
	函数说明 perror()用来将上一个函数发生错误的原因输出到标准错误(stderr)。参数s所指的字符串会先打印出，后面再加上错误原因字符串。此错误原因依照全局变量errno的值来决定要输出的字符串。<br>
	返回值<br>
	　</td>
	</tr>
</table>
...
<tr><td align="right" width="398"> 
	...
	执行 $ ./perror<br>
	fopen : No such file or diretory</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="perror.php#" class="bds_more" data-cmd="more"></a>
	<a href="perror.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="perror.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="perror.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="perror.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="perror.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
