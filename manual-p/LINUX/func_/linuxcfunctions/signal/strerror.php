...
<title>strerror函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">strerror（返回错误原因的描述字符串）<br>
	相关函数 perror<br>
	表头文件 #include&lt;string.h&gt;<br>
	定义函数 char * strerror(int errnum);<br>
	函数说明 strerror()用来依参数errnum的错误代码来查询其错误原因的描述<br>
	字符串，然后将该字符串指针返回。<br>
	返回值 返回描述错误原因的字符串指针。<br>
　</td>
	</tr>
</table>
　</td>
...
<tr><td align="right" width="398"> 
	<p align="left">范例:</p>
	<p align="left">/* 显示错误代码0 至9 的错误原因描述*/<br>
	#include&lt;string.h&gt;<br>
	main()<br>
	{<br>
	int i;<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="strerror.php#" class="bds_more" data-cmd="more"></a>
	<a href="strerror.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="strerror.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="strerror.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="strerror.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="strerror.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
