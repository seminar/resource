...
<title>signal函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">signal（设置信号处理方式）<br>
	相关函数 sigaction，kill，raise<br>
	表头文件 #include&lt;signal.h&gt;<br>
	定义函数 void (*signal(int signum,void(* handler)(int)))(int);<br>
	函数说明 signal()会依参数signum 指定的信号编号来设置该信号的处理函数。当指定的信号到达时就会跳转到参数handler指定的函数执行。<br>
	如果参数handler不是函数指针，则必须是下列两个常数之一:<br>
	SIG_IGN 忽略参数signum指定的信号。<br>
	SIG_DFL 将参数signum 指定的信号重设为核心预设的信号处理方<br>
	式。<br>
	关于信号的编号和说明，请参考附录D<br>
	返回值 返回先前的信号处理函数指针，如果有错误则返回SIG_ERR(-1)。<br>
	附加说明 在信号发生跳转到自定的handler处理函数执行后，系统会自动将此处理函数换回原来系统预设的处理方式，如果要改变此操作请改用sigaction()。</td>
	</tr>
</table>
　</td>
    <td background="../img_css/frame11.gif" width="14">　</td>
...
<tr><td align="right" width="398"> 
	<p align="left">范例:</p>
	<p align="left">参考alarm()或raise()。</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="signal.php#" class="bds_more" data-cmd="more"></a>
	<a href="signal.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="signal.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="signal.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="signal.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="signal.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
