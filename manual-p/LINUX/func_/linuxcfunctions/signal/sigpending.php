...
<title>sigpending函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">sigpending（查询被搁置的信号）<br>
	相关函数 signal，sigaction，sigprocmask，sigsuspend<br>
	表头文件 #include&lt;signal.h&gt;<br>
	定义函数 int sigpending(sigset_t *set);<br>
	函数说明 sigpending()会将被搁置的信号集合由参数set指针返回。<br>
	返回值执 行成功则返回0，如果有错误则返回-1。<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="sigpending.php#" class="bds_more" data-cmd="more"></a>
	<a href="sigpending.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="sigpending.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="sigpending.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="sigpending.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="sigpending.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
