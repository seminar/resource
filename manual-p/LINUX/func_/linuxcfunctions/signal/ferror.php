...
<title>ferror函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">ferror（检查文件流是否有错误发生）<br>
	相关函数 clearerr，perror<br>
	表头文件 #include&lt;stdio.h&gt;<br>
	定义函数 int ferror(FILE *stream);<br>
	函数说明 ferror()用来检查参数stream所指定的文件流是否发生了错误情况，如有错误发生则返回非0值。<br>
	返回值 如果文件流有错误发生则返回非0值。</td>
	</tr>
</table>
　</td>
    <td background="../img_css/frame11.gif" width="14">　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="ferror.php#" class="bds_more" data-cmd="more"></a>
	<a href="ferror.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="ferror.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="ferror.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="ferror.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="ferror.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
