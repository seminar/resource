...
<title>kill函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">kill（传送信号给指定的进程）<br>
	相关函数 raise，signal<br>
	表头文件 #include&lt;sys/types.h&gt;<br>
	#include&lt;signal.h&gt;<br>
	定义函数 int kill(pid_t pid,int sig);<br>
	函数说明<br>
	kill()可以用来送参数sig指定的信号给参数pid指定的进程。参数<br>
	pid有几种情况:<br>
...
<tr><td align="right" width="398"> 
	...
	执行 sen signal to child process(3170)<br>
	Hi I am child process!<br>
	child process receive signal 6</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="kill.php#" class="bds_more" data-cmd="more"></a>
	<a href="kill.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="kill.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="kill.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="kill.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="kill.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
