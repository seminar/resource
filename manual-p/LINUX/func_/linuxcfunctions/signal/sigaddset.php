...
<title>sigaddset函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">sigaddset（增加一个信号至信号集）<br>
	相关函数 sigemptyset，sigfillset，sigdelset，sigismember<br>
	表头文件 #include&lt;signal.h&gt;<br>
	定义函数 int sigaddset(sigset_t *set,int signum);<br>
	函数说明 sigaddset()用来将参数signum 代表的信号加入至参数set 信号集里。<br>
	返回值 执行成功则返回0，如果有错误则返回-1。<br>
	错误代码 EFAULT 参数set指针地址无法存取<br>
	EINVAL 参数signum非合法的信号编号</td>
	</tr>
</table>
　</td>
    <td background="../img_css/frame11.gif" width="14">　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="sigaddset.php#" class="bds_more" data-cmd="more"></a>
	<a href="sigaddset.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="sigaddset.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="sigaddset.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="sigaddset.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="sigaddset.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
