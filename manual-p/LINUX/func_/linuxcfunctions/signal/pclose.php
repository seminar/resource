...
<title>pclose函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">pclose（关闭管道I/O）<br>
	相关函数 popen<br>
	表头文件 #include&lt;stdio.h&gt;<br>
	定义函数 int pclose(FILE * stream);<br>
	函数说明 pclose()用来关闭由popen所建立的管道及文件指针。参数stream为先前由popen()所返回的文件指针。<br>
	返回值 返回子进程的结束状态。如果有错误则返回-1，错误原因存于errno中。<br>
	错误代码 ECHILD pclose()无法取得子进程的结束状态。</td>
	</tr>
</table>
　</td>
    <td background="../img_css/frame11.gif" width="14">　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="pclose.php#" class="bds_more" data-cmd="more"></a>
	<a href="pclose.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="pclose.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="pclose.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="pclose.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="pclose.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
