...
<title>pipe函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">pipe（建立管道）<br>
	相关函数 mkfifo，popen，read，write，fork<br>
	表头文件 #include&lt;unistd.h&gt;<br>
	定义函数 int pipe(int filedes[2]);<br>
	函数说明 pipe()会建立管道，并将文件描述词由参数filedes数组返回。<br>
	filedes[0]为管道里的读取端，filedes[1]则为管道的写入端。<br>
	返回值 若成功则返回零，否则返回-1，错误原因存于errno中。<br>
	错误代码 EMFILE 进程已用完文件描述词最大量。<br>
	ENFILE 系统已无文件描述词可用。<br>
	EFAULT 参数filedes数组地址不合法。<br>
　</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="pipe.php#" class="bds_more" data-cmd="more"></a>
	<a href="pipe.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="pipe.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="pipe.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="pipe.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="pipe.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
