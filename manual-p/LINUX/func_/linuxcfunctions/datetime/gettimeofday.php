...
<title>gettimeofday函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">gettimeofday（取得目前的时间）<br>
	相关函数 time，ctime，ftime，settimeofday<br>
	表头文件 #include &lt;sys/time.h&gt;<br>
	#include &lt;unistd.h&gt;<br>
	定义函数 int gettimeofday ( struct timeval * tv , struct timezone * tz )<br>
	函数说明 gettimeofday()会把目前的时间有tv所指的结构返回，当地时区的信息则放到tz所指的结构中。<br>
	timeval结构定义为:<br>
	struct timeval{<br>
	long tv_sec; /*秒*/<br>
	long tv_usec; /*微秒*/<br>
	...
	上述两个结构都定义在/usr/include/sys/time.h。tz_dsttime 所<br>
	代表的状态如下<br>
	DST_NONE /*不使用*/<br>
	DST_USA /*美国*/<br>
	DST_AUST /*澳洲*/<br>
	...
	返回值 成功则返回0，失败返回－1，错误代码存于errno。附加说明EFAULT<br>
	指针tv和tz所指的内存空间超出存取权限。<br>
　</td>
	</tr>
</table>
　</td>
...
<tr><td align="right" width="398"> 
	<p align="left">范例:</p>
	<p align="left">#include&lt;sys/time.h&gt;<br>
	#include&lt;unistd.h&gt;<br>
	main(){<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="gettimeofday.php#" class="bds_more" data-cmd="more"></a>
	<a href="gettimeofday.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="gettimeofday.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="gettimeofday.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="gettimeofday.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="gettimeofday.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
