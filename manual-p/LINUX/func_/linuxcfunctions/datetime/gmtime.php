...
<title>gmtime函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">gmtime（取得目前时间和日期）<br>
	相关函数 time,asctime,ctime,localtime<br>
	表头文件 #include&lt;time.h&gt;<br>
	定义函数 struct tm*gmtime(const time_t*timep);<br>
	函数说明 gmtime()将参数timep 所指的time_t 结构中的信息转换成真实世界所使用的时间日期表示方法，然后将结果由结构tm返回。<br>
	结构tm的定义为<br>
	struct tm<br>
	{<br>
	int tm_sec;<br>
...
<tr><td align="right" width="398"> 
	...
	time(&amp;timep);<br>
	p=gmtime(&amp;timep);<br>
	printf(“%d%d%d”,(1900+p-&gt;tm_year), (1+p-&gt;tm_mon),p-<br>
	&gt;tm_mday);<br>
	printf(“%s%d;%d;%d\n”, wday[p-&gt;tm_wday], p-&gt;tm_hour, p-<br>
	&gt;tm_min, p-&gt;tm_sec);<br>
	}<br>
	执行 2000/10/28 Sat 8:15:38</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="gmtime.php#" class="bds_more" data-cmd="more"></a>
	<a href="gmtime.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="gmtime.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="gmtime.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="gmtime.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="gmtime.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
