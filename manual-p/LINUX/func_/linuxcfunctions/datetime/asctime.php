...
<title>asctime函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">asctime（将时间和日期以字符串格式表示）<br>
	相关函数 time，ctime，gmtime，localtime<br>
	表头文件 #include&lt;time.h&gt;<br>
	定义函数 char * asctime(const struct tm * timeptr);<br>
	函数说明 asctime()将参数timeptr所指的tm结构中的信息转换成真实世界所使用的时间日期表示方法，然后将结果以字符串形态返回。此函数已经由时区转换成当地时间，字符串格式为:“Wed 
	Jun 30<br>
	21:49:08 1993\n”<br>
	返回值 若再调用相关的时间日期函数，此字符串可能会被破坏。此函数与ctime不同处在于传入的参数是不同的结构。<br>
	附加说明 返回一字符串表示目前当地的时间日期。<br>
	<br>
	　</td>
	</tr>
</table>
...
<tr><td align="right" width="398"> 
	...
	执行 Sat Oct 28 02:10:06 2000</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="asctime.php#" class="bds_more" data-cmd="more"></a>
	<a href="asctime.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="asctime.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="asctime.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="asctime.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="asctime.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
