...
<title>localtime函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">localtime（取得当地目前时间和日期）<br>
	相关函数 time, asctime, ctime, gmtime<br>
	表头文件 #include&lt;time.h&gt;<br>
	定义函数 struct tm *localtime(const time_t * timep);<br>
	函数说明 localtime()将参数timep所指的time_t结构中的信息转换成真实世界所使用的时间日期表示方法，然后将结果由结构tm返回。结构tm的定义请参考gmtime()。此函数返回的时间日期已经转换成当地时区。<br>
	返回值 返回结构tm代表目前的当地时间。<br>
	　</td>
	</tr>
</table>
　</td>
...
<tr><td align="right" width="398"> 
	<p align="left">范例:</p>
	<p align="left">#include&lt;time.h&gt;<br>
	main(){<br>
	char *wday[]={“Sun”,”Mon”,”Tue”,”Wed”,”Thu”,”<br>
	Fri”,”Sat”};<br>
	time_t timep;<br>
	struct tm *p;<br>
	time(&amp;timep);<br>
	p=localtime(&amp;timep); /*取得当地时间*/<br>
	printf (“%d%d%d ”, (1900+p-&gt;tm_year),( l+p-&gt;tm_mon), p-<br>
	&gt;tm_mday);<br>
	printf(“%s%d:%d:%d\n”, wday[p-&gt;tm_wday],p-&gt;tm_hour, p-<br>
	&gt;tm_min, p-&gt;tm_sec);<br>
	}<br>
	执行 2000/10/28 Sat 11:12:22</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="localtime.php#" class="bds_more" data-cmd="more"></a>
	<a href="localtime.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="localtime.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="localtime.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="localtime.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="localtime.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
