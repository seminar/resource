...
<title>mktime函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">mktime（将时间结构数据转换成经过的秒数）<br>
	相关函数 time，asctime，gmtime，localtime<br>
	表头文件 #include&lt;time.h&gt;<br>
	定义函数 time_t mktime(strcut tm * timeptr);<br>
	函数说明 mktime()用来将参数timeptr所指的tm结构数据转换成从公元1970年<br>
	1月1日0时0分0 秒算起至今的UTC时间所经过的秒数。<br>
	返回值 返回经过的秒数。<br>
　</td>
	</tr>
</table>
...
<tr><td align="right" width="398"> 
	<p align="left">范例:</p>
	<p align="left">/* 用time()取得时间（秒数），利用localtime()转换成struct tm 再利用mktine（）将struct 
	tm转换成原来的秒数*/<br>
	#include&lt;time.h&gt;<br>
	main()<br>
	{<br>
	...
	执行 time():974943297<br>
	time()-&gt;localtime()-&gt;mktime():974943297</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="mktime.php#" class="bds_more" data-cmd="more"></a>
	<a href="mktime.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="mktime.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="mktime.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="mktime.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="mktime.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
