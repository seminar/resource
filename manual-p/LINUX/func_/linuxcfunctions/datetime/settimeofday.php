...
<title>settimeofday函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<li><a href="../file/write.php">write</a></li>
  ...
  <h3>时间上期函数 </h3>
  <ul>
<li><a href="asctime.php">asctime</a></li>
<li><a href="ctime.php">ctime</a></li>
<li><a href="gettimeofday.php">gettimeofday</a></li>
<li><a href="gmtime.php">gmtime</a></li>
<li><a href="localtime.php">localtime</a></li>
<li><a href="mktime.php">mktime</a></li>
<li><a href="settimeofday.php">settimeofday</a></li>
...
<img border="0" src="../img_css/line.JPG" width="406" height="7"></div>
  ...
  <tr> 
    <td background="../img_css/frame10.gif" width="12">　</td>
    <td>
<table width="420" border="0" align="center" class="space" id="table35">
<tr><td align="right" width="414"> 
	<p align="left">settimeofday（设置目前时间）<br>
	相关函数 time，ctime，ftime，gettimeofday<br>
	表头文件 #include&lt;sys/time.h&gt;<br>
	#include&lt;unistd.h&gt;<br>
	定义函数 int settimeofday ( const struct timeval *tv,const struct timezone *tz);<br>
	函数说明 settimeofday()会把目前时间设成由tv所指的结构信息，当地时区信息则设成tz所指的结构。详细的说明请参考gettimeofday()。注意，只有root权限才能使用此函数修改时间。<br>
	返回值 成功则返回0，失败返回－1，错误代码存于errno。<br>
	错误代码 EPERM 并非由root权限调用settimeofday（），权限不够。<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="settimeofday.php#" class="bds_more" data-cmd="more"></a>
	<a href="settimeofday.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="settimeofday.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="settimeofday.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="settimeofday.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="settimeofday.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
