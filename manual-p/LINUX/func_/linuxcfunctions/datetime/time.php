...
<title>time函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">time（取得目前的时间）<br>
	相关函数 ctime，ftime，gettimeofday<br>
	表头文件 #include&lt;time.h&gt;<br>
	定义函数 time_t time(time_t *t);<br>
	函数说明 此函数会返回从公元1970年1月1日的UTC时间从0时0分0秒算起到现在所经过的秒数。如果t 
	并非空指针的话，此函数也会将返回值存到t指针所指的内存。<br>
	返回值 成功则返回秒数，失败则返回((time_t)-1)值，错误原因存于errno中。<br>
　</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="time.php#" class="bds_more" data-cmd="more"></a>
	<a href="time.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="time.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="time.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="time.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="time.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
