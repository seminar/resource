...
<title>pututline函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">pututline（将utmp 记录写入文件）<br>
	相关函数 getutent，getutid，getutline<br>
	表头文件 #include&lt;utmp.h&gt;<br>
	定义函数 void pututline(struct utmp *ut);<br>
	函数说明 pututline()用来将参数ut的utmp结构记录到utmp文件中。此函数会<br>
	先用getutid()来取得正确的写入位置，如果没有找到相符的记录则<br>
	会加入到utmp文件尾，utmp结构请参考getutent()。<br>
	返回值<br>
	附加说明 需要有写入/var/run/utmp 的权限<br>
　</td>
	</tr>
</table>
　</td>
...
<tr><td align="right" width="398"> 
	...
	strcpy(ut.ut_host,”www.th-tech.com”);<br>
	pututline(&amp;ut);<br>
	}<br>
	执行<br>
	/*执行范例后用指令who -l 观察*/<br>
	root pts/0 dec9 19:20<br>
	kids pts/1 dec12 10:31(www.th-tech.com)<br>
	root pts/2 dec12 13:33</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="pututline.php#" class="bds_more" data-cmd="more"></a>
	<a href="pututline.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="pututline.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="pututline.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="pututline.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="pututline.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
