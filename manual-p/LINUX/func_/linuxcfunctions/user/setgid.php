...
<title>setgid函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">setgid（设置真实的组识别码）<br>
	相关函数 getgid，setregid，getegid，setegid<br>
	表头文件 #include&lt;unistd.h&gt;<br>
	定义函数 int setgid(gid_t gid);<br>
	函数说明 setgid()用来将目前进程的真实组识别码(real gid)设成参数gid值。如果是以超级用户身份执行此调用，则real、effective与savedgid都会设成参数gid。<br>
	返回值 设置成功则返回0，失败则返回-1，错误代码存于errno中。<br>
	错误代码 EPERM 并非以超级用户身份调用，而且参数gid 并非进程的effective gid或saved gid值之一。</td>
	</tr>
</table>
　</td>
    <td background="../img_css/frame11.gif" width="14">　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="setgid.php#" class="bds_more" data-cmd="more"></a>
	<a href="setgid.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="setgid.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="setgid.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="setgid.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="setgid.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
