...
<title>initgroups函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">initgroups（初始化组清单）<br>
	相关函数 setgrent，endgrent<br>
	表头文件 #include&lt;grp.h&gt;<br>
	#include&lt;sys/types.h&gt;<br>
	定义函数 int initgroups(const char *user,gid_t group);<br>
	函数说明 initgroups（）用来从组文件（/etc/group）中读取一项组数据，<br>
	若该组数据的成员中有参数user时，便将参数group组识别码加入到<br>
	此数据中。<br>
	返回值 执行成功则返回0，失败则返回-1，错误码存于errno。<br>
　</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="initgroups.php#" class="bds_more" data-cmd="more"></a>
	<a href="initgroups.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="initgroups.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="initgroups.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="initgroups.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="initgroups.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
