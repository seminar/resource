...
<title>endgrent函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">endgrent（关闭组文件）<br>
	相关函数 getgrent，setgrent<br>
	表头文件 #include&lt;grp.h&gt;<br>
	#include&lt;sys/types.h&gt;<br>
	定义函数 void endgrent(void);<br>
	函数说明 endgrent()用来关闭由getgrent()所打开的密码文件。<br>
	返回值<br>
	附加说明<br>
　</td>
	</tr>
...
<tr><td align="right" width="398"> 
	<p align="left">范例:</p>
	<p align="left">请参考getgrent()与setgrent()。</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="endgrent.php#" class="bds_more" data-cmd="more"></a>
	<a href="endgrent.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="endgrent.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="endgrent.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="endgrent.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="endgrent.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
