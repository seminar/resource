...
<title>setgroups函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">setgroups（设置组代码）<br>
	相关函数 initgroups，getgroup，getgid，setgid<br>
	表头文件 #include&lt;grp.h&gt;<br>
	定义函数 int setgroups(size_t size,const gid_t * list);<br>
	函数说明 setgroups()用来将list 数组中所标明的组加入到目前进程的组设置中。参数size为list()的gid_t数目，最大值为NGROUP(32)。<br>
	返回值 设置成功则返回0，如有错误则返回-1。<br>
	错误代码 EFAULT 参数list数组地址不合法。<br>
	EPERM 权限不足，必须是root权限<br>
	EINVAL 参数size值大于NGROUP(32)。</td>
	</tr>
</table>
　</td>
    <td background="../img_css/frame11.gif" width="14">　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="setgroups.php#" class="bds_more" data-cmd="more"></a>
	<a href="setgroups.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="setgroups.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="setgroups.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="setgroups.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="setgroups.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
