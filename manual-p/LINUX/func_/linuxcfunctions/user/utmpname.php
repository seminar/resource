...
<title>utmpname函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">utmpname（设置utmp 文件路径）<br>
	相关函数 getutent，getutid，getutline，setutent，endutent，pututline<br>
	表头文件 #include&lt;utmp.h&gt;<br>
	定义函数 void utmpname(const char * file);<br>
	函数说明 utmpname()用来设置utmp文件的路径，以提供utmp相关函数的存取路径。如果没有使用utmpname()则默认utmp文件路径为/var/run/utmp。<br>
	返回值</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="utmpname.php#" class="bds_more" data-cmd="more"></a>
	<a href="utmpname.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="utmpname.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="utmpname.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="utmpname.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="utmpname.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
