...
<title>getutline函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">getutline（从utmp 文件中查找特定的记录）<br>
	相关函数 getutent，getutid，pututline<br>
	表头文件 #include&lt;utmp.h&gt;<br>
	定义函数 struct utmp * getutline (struct utmp *ut);<br>
	函数说明 getutline()用来从目前utmp文件的读写位置逐一往后搜索ut_type<br>
	为USER_PROCESS 或LOGIN_PROCESS 的记录，而且ut_line 和ut-<br>
	&gt;ut_line 相符。找到相符的记录便将该数据以utmp 结构返回，<br>
	utmp结构请参考getutent()。<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="getutline.php#" class="bds_more" data-cmd="more"></a>
	<a href="getutline.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="getutline.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="getutline.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="getutline.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="getutline.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
