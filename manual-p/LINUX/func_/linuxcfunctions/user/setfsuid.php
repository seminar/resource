...
<title>setfsuid函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">setfsuid（设置文件系统的用户识别码）<br>
	相关函数 setuid，setreuid，seteuid，setfsgid<br>
	表头文件 #include&lt;unistd.h&gt;<br>
	定义函数 int setfsuid(uid_t fsuid);<br>
	函数说明 setfsuid()用来重新设置目前进程的文件系统的用户识别码。一般情况下，文件系统的用户识别码(fsuid)与有效的用户识别码(euid)是相同的。如果是超级用户调用此函数，参数fsuid可以为任何值，否则参数fsuid必须为real/effective/saved的用户识别码之一。<br>
	返回值 执行成功则返回0，失败则返回-1，错误代码存于errno<br>
	附加说明 此函数为Linux特有<br>
	错误代码 EPERM 权限不够，无法完成设置。</td>
	</tr>
</table>
　</td>
    <td background="../img_css/frame11.gif" width="14">　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="setfsuid.php#" class="bds_more" data-cmd="more"></a>
	<a href="setfsuid.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="setfsuid.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="setfsuid.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="setfsuid.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="setfsuid.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
