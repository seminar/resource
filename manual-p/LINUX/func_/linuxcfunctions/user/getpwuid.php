...
<title>getpwuid函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">getpwuid（从密码文件中取得指定uid 的数据）<br>
	相关函数 getpw，fgetpwent，getpwent，getpwnam<br>
	表头文件 #include&lt;pwd.h&gt;<br>
	#include&lt;sys/types.h&gt;<br>
	定义函数 struct passwd * getpwuid(uid_t uid);<br>
	函数说明 getpwuid()用来逐一搜索参数uid 指定的用户识别码，找到时便将<br>
	该用户的数据以结构返回结构请参考将该用户的数据以passwd 结构<br>
	返回。passwd 结构请参考getpwent()。<br>
	返回值 返回passwd 结构数据，如果返回NULL 则表示已无数据，或者有错<br>
	误发生。</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="getpwuid.php#" class="bds_more" data-cmd="more"></a>
	<a href="getpwuid.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="getpwuid.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="getpwuid.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="getpwuid.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="getpwuid.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
