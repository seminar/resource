...
<title>getutent函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<div class="c_l">
  <h3>用户组函数 </h3>
  <ul>
  <li><a href="utmpname.php">utmpname</a></li>
<li><a href="setutent.php">setutent</a></li>
<li><a href="setuid.php">setuid</a></li>
<li><a href="setreuid.php">setreuid</a></li>
<li><a href="setregid.php">setregid</a></li>
<li><a href="setpwent.php">setpwent</a></li>
<li><a href="setgroups.php">setgroups</a></li>
<li><a href="setgrent.php">setgrent</a></li>
<li><a href="setgid.php">setgid</a></li>
<li><a href="setfsuid.php">setfsuid</a></li>
<li><a href="setfsgid.php">setfsgid</a></li>
<li><a href="seteuid.php">seteuid</a></li>
<li><a href="pututline.php">pututline</a></li>
<li><a href="initgroups.php">initgroups</a></li>
<li><a href="getutline.php">getutline</a></li>
<li><a href="getutid.php">getutid</a></li>
<li><a href="getutent.php">getutent</a></li>
<li><a href="getuid.php">getuid</a></li>
<li><a href="getpwuid.php">getpwuid</a></li>
<li><a href="getpwnam.php">getpwnam</a></li>
<li><a href="getpwent.php">getpwent</a></li>
<li><a href="getpw.php">getpw</a></li>
<li><a href="getgroups.php">getgroups</a></li>
<li><a href="getgrnam.php">getgrnam</a></li>
<li><a href="getgrgid.php">getgrgid</a></li>
<li><a href="getgrent.php">getgrent</a></li>
<li><a href="getgid.php">agetgid</a></li>
<li><a href="geteuid.php">geteuid</a></li>
<li><a href="getegid.php">getegid</a></li>
<li><a href="fgetpwent.php">fgetpwent</a></li>
<li><a href="fgetgrent.php">fgetgrent</a></li>
<li><a href="endutent.php">endutent</a></li>
<li><a href="endpwent.php">endpwent</a></li>
<li><a href="endgrent.php">endgrent</a></li>
</ul>
  <h3>信号处理函数 </h3>
  <ul>
...
<tr><td align="right" width="398"> 
	<p align="left">getutent（从utmp 文件中取得账号登录数据）<br>
	相关函数 getutent，getutid，getutline，setutent，endutent，<br>
	pututline，utmpname<br>
	表头文件 #include&lt;utmp.h&gt;<br>
	定义函数 struct utmp *getutent(void);<br>
	函数说明<br>
	getutent()用来从utmp 文件(/var/run/utmp)中读取一项登录数<br>
	据，该数据以utmp 结构返回。第一次调用时会取得第一位用户数<br>
	据，之后每调用一次就会返回下一项数据，直到已无任何数据时返<br>
	回NULL。<br>
	utmp结构定义如下<br>
	struct utmp<br>
	{<br>
	...
	struxt exit_status ut_exit;/* 当类型为DEAD_PROCESS时进程的结束状态*/<br>
	...
	ut_type有以下几种类型:<br>
	Untitled Document 页码，12/20<br>
	file://D:\linux_c\function\07.html 2004-1-9<br>
	EMPTY 此为空的记录。<br>
	...
	UT_NAMESIZE 32<br>
	UT_HOSTSIZE 256<br>
	返回值 返回utmp 结构数据，如果返回NULL 则表示已无数据，或有错误发生。<br>
	附加说明 getutent()在第一次调用时会打开utmp 文件，读取数据完毕后可使用endutent()来关闭该utmp文件。<br>
　</td>
	</tr>
</table>
　</td>
...
<tr><td align="right" width="398"> 
	<p align="left">范例:</p>
	<p align="left">#include&lt;utmp.h&gt;<br>
	main()<br>
	{<br>
	struct utmp *u;<br>
	while((u=getutent())){<br>
	if(u-&gt;ut_type = = USER_PROCESS)<br>
	printf(“%d %s %s %s \n”,u-&gt;ut_type,u-&gt;ut_user,u-<br>
	&gt;ut_line,u-&gt;ut_host);<br>
	}<br>
	endutent();<br>
	}<br>
	执行 /* 表示有三个root账号分别登<br>
	录/dev/pts/0，/dev/pts/1，/dev/pts/2 */<br>
	7 root pts/0<br>
	7 root pts/1<br>
	7 root pts/2</td>
	</tr>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="getutent.php#" class="bds_more" data-cmd="more"></a>
	<a href="getutent.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="getutent.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="getutent.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="getutent.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="getutent.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
