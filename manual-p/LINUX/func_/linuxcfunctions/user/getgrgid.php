...
<title>getgrgid函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">getgrgid（从组文件中取得指定gid 的数据）<br>
	相关函数 fgetgrent，getgrent，getgrnam<br>
	表头文件 #include&lt;grp.h&gt;<br>
	#include&lt;sys/types.h&gt;<br>
	定义函数 strcut group * getgrgid(gid_t gid);<br>
	函数说明 getgrgid（）用来依参数gid指定的组识别码逐一搜索组文件，找到<br>
	时便将该组的数据以group结构返回。group结构请参考getgrent<br>
	（）。<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="getgrgid.php#" class="bds_more" data-cmd="more"></a>
	<a href="getgrgid.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="getgrgid.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="getgrgid.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="getgrgid.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="getgrgid.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
