...
<title>getpwnam函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">getpwnam（从密码文件中取得指定账号的数据）<br>
	相关函数 getpw，fgetpwent，getpwent，getpwuid<br>
	表头文件 #include&lt;pwd.h&gt;<br>
	#include&lt;sys/types.h&gt;<br>
	定义函数 struct passwd * getpwnam(const char * name);<br>
	函数说明 getpwnam()用来逐一搜索参数name 指定的账号名称，找到时便将该<br>
	用户的数据以passwd结构返回。passwd结构请参考getpwent()。<br>
...
<tr><td align="right" width="398"> 
	<p align="left">范例:</p>
	<p align="left">/*取得root账号的识别码和根目录*/<br>
	#include&lt;pwd.h&gt;<br>
	#include&lt;sys/types.h&gt;<br>
	main()<br>
	{<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="getpwnam.php#" class="bds_more" data-cmd="more"></a>
	<a href="getpwnam.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="getpwnam.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="getpwnam.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="getpwnam.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="getpwnam.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
