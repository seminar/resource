...
<title>setregid函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">setregid（设置真实及有效的组识别码）<br>
	相关函数 setgid，setegid，setfsgid<br>
	表头文件 #include&lt;unistd.h&gt;<br>
	定义函数 int setregid(gid_t rgid,gid_t egid);<br>
	函数说明<br>
	setregid()用来将参数rgid设为目前进程的真实组识别码，将参数<br>
	egid设置为目前进程的有效组识别码。如果参数rgid或egid值为-<br>
	1，则对应的识别码不会改变。<br>
	返回值 执行成功则返回0，失败则返回-1，错误代码存于errno。</td>
	</tr>
</table>
　</td>
    <td background="../img_css/frame11.gif" width="14">　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="setregid.php#" class="bds_more" data-cmd="more"></a>
	<a href="setregid.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="setregid.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="setregid.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="setregid.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="setregid.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
