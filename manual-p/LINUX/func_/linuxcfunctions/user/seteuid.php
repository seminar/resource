...
<title>seteuid函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">seteuid（设置有效的用户识别码）<br>
	相关函数 setuid，setreuid，setfsuid<br>
	表头文件 #include&lt;unistd.h&gt;<br>
	定义函数 int seteuid(uid_t euid);<br>
	函数说明 seteuid()用来重新设置执行目前进程的有效用户识别码。在Linux下，seteuid(euid)相当于setreuid(-1,euid)。<br>
...
<tr><td align="right" width="398"> 
	<p align="left">范例:</p>
	<p align="left">无<p align="left">　</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="seteuid.php#" class="bds_more" data-cmd="more"></a>
	<a href="seteuid.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="seteuid.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="seteuid.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="seteuid.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="seteuid.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
