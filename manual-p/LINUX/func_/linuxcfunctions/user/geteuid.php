...
<title>geteuid函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">geteuid（取得有效的用户识别码）<br>
	相关函数 getuid，setreuid，setuid<br>
	表头文件 #include&lt;unistd.h&gt;<br>
	#include&lt;sys/types.h&gt;<br>
	定义函数 uid_t geteuid(void)<br>
	函数说明 geteuid()用来取得执行目前进程有效的用户识别码。有效的用户识<br>
	别码用来决定进程执行的权限，借由此改变此值，进程可以获得额<br>
	外的权限。倘若执行文件的setID位已被设置，该文件执行时，其进<br>
	程的euid值便会设成该文件所有者的uid。例如，执行文<br>
	件/usr/bin/passwd的权限为-r-s--x--x，其s 位即为setID(SUID)<br>
	位，而当任何用户在执行passwd 时其有效的用户识别码会被设成<br>
	passwd 所有者的uid 值，即root的uid 值(0)。<br>
	返回值 返回有效的用户识别码。<br>
　</td>
	</tr>
</table>
...
<tr><td align="right" width="398"> 
	...
	执行 euid is 0 /*当使用root身份执行范例程序时*/</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="geteuid.php#" class="bds_more" data-cmd="more"></a>
	<a href="geteuid.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="geteuid.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="geteuid.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="geteuid.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="geteuid.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
