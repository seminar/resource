...
<title>getgrent函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">getgrent（从组文件中取得账号的数据）<br>
	相关函数 setgrent，endgrent<br>
	表头文件 #include&lt;grp.h&gt;<br>
	#include &lt;sys/types.h&gt;<br>
	定义函数 struct group *getgrent(void);<br>
	函数说明 getgrent()用来从组文件(/etc/group)中读取一项组数据，该数据<br>
	以group 结构返回。第一次调用时会取得第一项组数据，之后每调<br>
	用一次就会返回下一项数据，直到已无任何数据时返回NULL。<br>
	struct group{<br>
	char *gr_name; /*组名称*/<br>
	...
	返回值 返回group结构数据，如果返回NULL则表示已无数据，或有错误发<br>
	生。<br>
	附加说明 getgrent()在第一次调用时会打开组文件，读取数据完毕后可使用<br>
	endgrent()来关闭该组文件。<br>
	错误代码 ENOMEM 内存不足，无法配置group结构。<br>
　</td>
	</tr>
</table>
　</td>
...
<tr><td align="right" width="398"> 
	...
	i=0;<br>
	printf(“%s:%s:%d:”,data-&gt;gr_name,data-&gt;gr_passwd,data-<br>
	&gt;gr_gid);<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="getgrent.php#" class="bds_more" data-cmd="more"></a>
	<a href="getgrent.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="getgrent.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="getgrent.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="getgrent.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="getgrent.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
