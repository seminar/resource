...
<title>setreuid函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">setreuid（设置真实及有效的用户识别码）<br>
	相关函数 setuid，seteuid，setfsuid<br>
	表头文件 #include&lt;unistd.h&gt;<br>
	定义函数 int setreuid(uid_t ruid,uid_t euid);<br>
	函数说明 setreuid()用来将参数ruid 设为目前进程的真实用户识别码，将参<br>
	数euid 设置为目前进程的有效用户识别码。如果参数ruid 或euid<br>
	值为-1，则对应的识别码不会改变。<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="setreuid.php#" class="bds_more" data-cmd="more"></a>
	<a href="setreuid.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="setreuid.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="setreuid.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="setreuid.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="setreuid.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
