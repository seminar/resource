...
<title>agetgid函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">agetgid（取得真实的组识别码）<br>
	相关函数 getegid，setregid，setgid<br>
	表头文件 #include&lt;unistd.h&gt;<br>
	#include&lt;sys/types.h&gt;<br>
	定义函数 gid_t getgid(void);<br>
	函数说明 getgid()用来取得执行目前进程的组识别码。<br>
	返回值 返回组识别码<br>
　</td>
	</tr>
</table>
...
<tr><td align="right" width="398"> 
	...
	执行 gid is 0 /*当使用root身份执行范例程序时*/</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="getgid.php#" class="bds_more" data-cmd="more"></a>
	<a href="getgid.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="getgid.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="getgid.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="getgid.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="getgid.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
