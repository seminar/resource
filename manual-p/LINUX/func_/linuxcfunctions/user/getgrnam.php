...
<title>getgrnam函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">getgrnam（从组文件中取得指定组的数据）<br>
	相关函数 fgetgrent，getrent，getgruid<br>
	表头文件 #include&lt;grp.h&gt;<br>
	#include&lt;sys/types.h&gt;<br>
	定义函数 strcut group * getgrnam(const char * name);<br>
	函数说明 getgrnam（）用来逐一搜索参数那么指定的组名称，找到时便将该<br>
	组的数据以group结构返回。group 结构请参考getgrent（）。<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="getgrnam.php#" class="bds_more" data-cmd="more"></a>
	<a href="getgrnam.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="getgrnam.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="getgrnam.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="getgrnam.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="getgrnam.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
