...
<title>getegid函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">getegid（取得有效的组识别码）<br>
	相关函数 getgid，setgid，setregid<br>
	表头文件 #include&lt;unistd.h&gt;<br>
	#include&lt;sys/types.h&gt;<br>
	定义函数 gid_t getegid(void);<br>
	函数说明 getegid()用来取得执行目前进程有效组识别码。有效的组识别码用<br>
	来决定进程执行时组的权限。返回值返回有效的组识别码。<br>
　</td>
	</tr>
</table>
　</td>
...
<tr><td align="right" width="398"> 
	...
	执行 egid is 0 /*当使用root身份执行范例程序时*/</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="getegid.php#" class="bds_more" data-cmd="more"></a>
	<a href="getegid.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="getegid.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="getegid.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="getegid.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="getegid.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
