...
<title>endpwent函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">endpwent（关闭密码文件）<br>
	相关函数 getpwent，setpwent<br>
	表头文件 #include&lt;pwd.h&gt;<br>
	#include&lt;sys/types.h&gt;<br>
	定义函数 void endpwent(void);<br>
	函数说明 endpwent()用来关闭由getpwent()所打开的密码文件。<br>
	返回值<br>
	附加说明</td>
	</tr>
</table>
...
<tr><td align="right" width="398"> 
	<p align="left">范例:</p>
	<p align="left">请参考getpwent()与setpwent()。</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="endpwent.php#" class="bds_more" data-cmd="more"></a>
	<a href="endpwent.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="endpwent.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="endpwent.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="endpwent.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="endpwent.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
