...
<title>setutent函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">setutent（从头读取utmp 文件中的登录数据）<br>
	相关函数 getutent，endutent<br>
	表头文件 #include&lt;utmp.h&gt;<br>
	定义函数 void setutent(void);<br>
	函数说明 setutent()用来将getutent()的读写地址指回utmp文件开头。<br>
	附加说明 请参考setpwent()或setgrent()。</td>
	</tr>
</table>
　</td>
    <td background="../img_css/frame11.gif" width="14">　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="setutent.php#" class="bds_more" data-cmd="more"></a>
	<a href="setutent.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="setutent.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="setutent.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="setutent.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="setutent.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
