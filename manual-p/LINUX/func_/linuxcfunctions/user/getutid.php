...
<title>getutid函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">getutid（从utmp 文件中查找特定的记录）<br>
	相关函数 getutent，getutline<br>
	表头文件 #include&lt;utmp.h&gt;<br>
	定义函数 strcut utmp *getutid(strcut utmp *ut);<br>
	函数说明 getutid()用来从目前utmp 文件的读写位置逐一往后搜索参数ut指<br>
	定的记录，如果ut-&gt;ut_type 为RUN_LVL，BOOT_TIME，NEW_TIME，<br>
	OLD_TIME 其中之一则查找与ut-&gt;ut_type 相符的记录；若ut-<br>
	&gt;ut_type 为INIT_PROCESS，LOGIN_PROCESS，USER_PROCESS或<br>
	DEAD_PROCESS其中之一，则查找与ut-&gt;ut_id相符的记录。找到相符<br>
	的记录便将该数据以utmp 结构返回。utmp结构请参考getutent()。<br>
	返回值 返回utmp 结构数据，如果返回NULL 则表示已无数据，或有错误发<br>
	生。<br>
　</td>
	</tr>
</table>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="getutid.php#" class="bds_more" data-cmd="more"></a>
	<a href="getutid.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="getutid.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="getutid.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="getutid.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="getutid.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
