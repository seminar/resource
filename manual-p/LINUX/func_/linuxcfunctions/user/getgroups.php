...
<title>getgroups函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">getgroups（取得组代码）<br>
	相关函数 initgroups，setgroup，getgid，setgid<br>
	表头文件 #include&lt;unistd.h&gt;<br>
	#include&lt;sys/types.h&gt;<br>
	定义函数 int getgroups(int size,gid_t list[]);<br>
	函数说明 getgroup（）用来取得目前用户所属的组代码。参数size为list<br>
	〔〕所能容纳的gid_t 数目。如果参数size 值为零，此函数仅会返<br>
	回用户所属的组数。<br>
	返回值 返回组识别码，如有错误则返回-1。<br>
	错误代码 EFAULT 参数list数组地址不合法。EINVAL 参数size值不足以容纳<br>
	所有的组。<br>
　</td>
	</tr>
</table>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="getgroups.php#" class="bds_more" data-cmd="more"></a>
	<a href="getgroups.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="getgroups.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="getgroups.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="getgroups.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="getgroups.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
