...
<title>getpw函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">getpw（取得指定用户的密码文件数据）<br>
	相关函数 getpwent<br>
	表头文件 #include&lt;pwd.h&gt;<br>
	#include&lt;sys/types.h&gt;<br>
	定义函数 int getpw(uid_t uid,char *buf);<br>
	函数说明 getpw()会从/etc/passwd中查找符合参数uid所指定的用户账号数<br>
	据，找不到相关数据就返回-1。所返回的buf字符串格式如下:账号:<br>
	密码:用户识别码(uid):组识别码(gid):全名:根目录:shell<br>
	返回值 返回0表示成功，有错误发生时返回-1。<br>
	附加说明 1. getpw()会有潜在的安全性问题，请尽量使用别的函数取代。<br>
	2. 使用shadow的系统已把用户密码抽出/etc/passwd，因此使用<br>
	getpw()取得的密码将为“x”。<br>
　</td>
	</tr>
</table>
...
<tr><td align="right" width="398"> 
	...
	执行 root:x:0:0:root:/root:/bin/bash</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="getpw.php#" class="bds_more" data-cmd="more"></a>
	<a href="getpw.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="getpw.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="getpw.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="getpw.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="getpw.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
