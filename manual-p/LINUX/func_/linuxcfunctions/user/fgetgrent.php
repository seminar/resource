...
<title>fgetgrent函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">fgetgrent（从指定的文件来读取组格式）<br>
	相关函数 fgetpwent<br>
	表头文件 #include&lt;grp.h&gt;<br>
	#include&lt;stdio.h&gt;<br>
	#include&lt;sys/types.h&gt;<br>
	定义函数 struct group * getgrent(FILE * stream);<br>
	函数说明 fgetgrent()会从参数stream指定的文件读取一行数据，然后以<br>
	group结构将该数据返回。参数stream所指定的文件必须和、<br>
	etc/group相同的格式。group结构定义请参考getgrent()。<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="fgetgrent.php#" class="bds_more" data-cmd="more"></a>
	<a href="fgetgrent.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="fgetgrent.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="fgetgrent.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="fgetgrent.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="fgetgrent.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
