...
<title>gets函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">gets（由标准输入设备内读进一字符串）<br>
	...
	附加说明 由于gets()无法知道字符串s的大小，必须遇到换行字符或文件尾才会结束输入，因此容易造成缓冲溢出的安全性问题。建议使用fgets()取代。<br>
　</td>
	</tr>
</table>
　</td>
...
<tr><td align="right" width="398"> 
	<p align="left">范例:</p>
	<p align="left">#ingclude &lt;stdlib.h&gt;<br>
	main(){<br>
	int ansert;<br>
	answer = abs(-12);<br>
	printf(&quot;|-12| = %d\n&quot;, answer);<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="gets.php#" class="bds_more" data-cmd="more"></a>
	<a href="gets.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="gets.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="gets.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="gets.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="gets.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
