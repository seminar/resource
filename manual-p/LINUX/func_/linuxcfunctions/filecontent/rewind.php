...
<title>rewind函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">rewind（重设文件流的读写位置为文件开头）<br>
	相关函数 fseek，ftell，fgetpos，fsetpos<br>
	表头文件 #include&lt;stdio.h&gt;<br>
	定义函数 void rewind(FILE * stream);<br>
	函数说明 
	rewind()用来把文件流的读写位置移至文件开头。参数stream为已打开的文件指针。此函数相当于调用fseek(stream,0,SEEK_SET)。<br>
	返回值</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="rewind.php#" class="bds_more" data-cmd="more"></a>
	<a href="rewind.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="rewind.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="rewind.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="rewind.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="rewind.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
