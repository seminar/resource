...
<title>fopen函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<li><a href="../filepermission/utimes.php">utimes</a></li>
  ...
  <h3>文件内容控制函数 </h3>
  <ul>
<li><a href="clearerr.php">clearerr</a></li>
<li><a href="fclose.php">fclose</a></li>
<li><a href="fdopen.php">fdopen</a></li>
<li><a href="feof.php">feof</a></li>
<li><a href="fflush.php">fflush</a></li>
<li><a href="fgetc.php">fgetc</a></li>
<li><a href="fgets.php">fgets</a></li>
<li><a href="fileno.php">fileno</a></li>
<li><a href="fopen.php">fopen</a></li>
<li><a href="fputc.php">fputc</a></li>
<li><a href="fputs.php">fputs</a></li>
<li><a href="fread.php">fread</a></li>
<li><a href="freopen.php">freopen</a></li>
<li><a href="fseek.php">fseek</a></li>
<li><a href="ftell.php">ftell</a></li>
<li><a href="fwrite.php">fwrite</a></li>
<li><a href="getc.php">getc</a></li>
<li><a href="getchar.php">getchar</a></li>
<li><a href="gets.php">gets</a></li>
<li><a href="mktemp.php">mktemp</a></li>
<li><a href="putc.php">putc</a></li>
<li><a href="putchar.php">putchar</a></li>
<li><a href="rewind.php">rewind</a></li>
<li><a href="setbuf.php">setbuf</a></li>
<li><a href="setbuffer.php">setbuffer</a></li>
<li><a href="setlinebuf.php">setlinebuf</a></li>
<li><a href="setvbuf.php">setvbuf</a></li>
<li><a href="ungetc.php">ungetc</a></li>
</ul>
  <h3>数据结构和算法 </h3>
  <ul>
...
<tr><td align="right" width="398"> 
	...
	w 打开只写文件，若文件存在则文件长度清为0，即该文件内容会消<br>
	失。若文件不存在则建立该文件。<br>
	w+ 打开可读写文件，若文件存在则文件长度清为零，即该文件内容<br>
	会消失。若文件不存在则建立该文件。<br>
	a 以附加的方式打开只写文件。若文件不存在，则会建立该文件，<br>
	如果文件存在，写入的数据会被加到文件尾，即文件原先的内容会<br>
	被保留。<br>
	a+ 以附加方式打开可读写的文件。若文件不存在，则会建立该文<br>
	件，如果文件存在，写入的数据会被加到文件尾后，即文件原先的<br>
	内容会被保留。<br>
	上述的形态字符串都可以再加一个b字符，如rb、w+b或ab＋等组<br>
	合，加入b 字符用来告诉函数库打开的文件为二进制文件，而非纯<br>
	文字文件。不过在POSIX系统，包含Linux都会忽略该字符。由fopen<br>
	()所建立的新文件会具有<br>
	S_IRUSR|S_IWUSR|S_IRGRP|S_IWGRP|S_IROTH|S_IWOTH(0666)权限，此文件权限也会参考umask值。<br>
	返回值 文件顺利打开后，指向该流的文件指针就会被返回。若果文件打开失败则返回NULL，并把错误代码存在errno 中。<br>
	附加说明 一般而言，开文件后会作一些文件读取或写入的动作，若开文件失败，接下来的读写动作也无法顺利进行，所以在fopen()后请作错误判断及处理。<br>
　</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="fopen.php#" class="bds_more" data-cmd="more"></a>
	<a href="fopen.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="fopen.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="fopen.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="fopen.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="fopen.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
