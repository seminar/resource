...
<title>putc函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">putc（将一指定字符写入文件中）<br>
	...
	返回值 putc()会返回写入成功的字符，即参数c。若返回EOF则代表写入失败。</td>
	</tr>
</table>
　</td>
    <td background="../img_css/frame11.gif" width="14">　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="putc.php#" class="bds_more" data-cmd="more"></a>
	<a href="putc.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="putc.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="putc.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="putc.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="putc.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
