...
<title>getc函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<img border="0" src="../img_css/line.JPG" width="406" height="7"></div>
  ...
  <tr> 
    <td background="../img_css/frame10.gif" width="12">　</td>
    <td>
<table width="407" border="0" align="center" class="space" id="table35">
<tr><td align="right" width="401"> 
	<p align="left">getc（由文件中读取一个字符）<br>
	...
	返回值 getc()会返回读取到的字符，若返回EOF则表示到了文件尾。</td>
	</tr>
</table>
　</td>
    <td background="../img_css/frame11.gif" width="14">　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="getc.php#" class="bds_more" data-cmd="more"></a>
	<a href="getc.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="getc.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="getc.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="getc.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="getc.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
