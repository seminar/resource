...
<title>fflush函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">fflush（更新缓冲区）<br>
	相关函数 write，fopen，fclose，setbuf<br>
	表头文件 #include&lt;stdio.h&gt;<br>
	定义函数 int fflush(FILE* stream);<br>
	函数说明 fflush()会强迫将缓冲区内的数据写回参数stream指定的文件中。<br>
	如果参数stream为NULL，fflush()会将所有打开的文件数据更新。<br>
	返回值 成功返回0，失败返回EOF，错误代码存于errno中。<br>
	错误代码 EBADF 参数stream 指定的文件未被打开，或打开状态为只读。其它错误代码参考write（）。</td>
	</tr>
</table>
　</td>
    <td background="../img_css/frame11.gif" width="14">　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="fflush.php#" class="bds_more" data-cmd="more"></a>
	<a href="fflush.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="fflush.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="fflush.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="fflush.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="fflush.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
