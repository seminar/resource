...
<title>getchar函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<img border="0" src="../img_css/line.JPG" width="406" height="7"></div>
  ...
  <tr> 
    <td background="../img_css/frame10.gif" width="12">　</td>
    <td>
<table width="385" border="0" align="center" class="space" id="table35">
<tr><td align="right" width="379"> 
	<p align="left">getchar（由标准输入设备内读进一字符）<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="getchar.php#" class="bds_more" data-cmd="more"></a>
	<a href="getchar.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="getchar.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="getchar.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="getchar.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="getchar.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
