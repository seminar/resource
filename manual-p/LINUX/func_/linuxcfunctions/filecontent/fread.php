...
<title>fread函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">fread（从文件流读取数据）<br>
	相关函数 fopen，fwrite，fseek，fscanf<br>
	表头文件 #include&lt;stdio.h&gt;<br>
	定义函数 size_t fread(void * ptr,size_t size,size_t nmemb,FILE *<br>
	stream);<br>
	函数说明 fread()用来从文件流中读取数据。参数stream为已打开的文件指针，参数ptr 
	指向欲存放读取进来的数据空间，读取的字符数以参数size*nmemb来决定。Fread()会返回实际读取到的nmemb数目，如果此值比参数nmemb 
	来得小，则代表可能读到了文件尾或有错误发生，这时必须用feof()或ferror()来决定发生什么情况。<br>
	返回值 返回实际读取到的nmemb数目。<br>
	附加说明<br>
　</td>
	</tr>
</table>
...
<tr><td align="right" width="398"> 
	<p align="left">范例:</p>
	<p align="left">范例 #include&lt;stdio.h&gt;<br>
	#define nmemb 3<br>
	struct test<br>
	{<br>
	char name[20];<br>
	...
	执行 name[0]=Linux! size[0]=6<br>
	name[1]=FreeBSD! size[1]=8<br>
	name[2]=Windows2000 size[2]=11</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="fread.php#" class="bds_more" data-cmd="more"></a>
	<a href="fread.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="fread.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="fread.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="fread.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="fread.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
