...
<title>ftell函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">ftell（取得文件流的读取位置）<br>
	...
	错误代码 EBADF 参数stream无效或可移动读写位置的文件流。</td>
	</tr>
</table>
　</td>
    <td background="../img_css/frame11.gif" width="14">　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="ftell.php#" class="bds_more" data-cmd="more"></a>
	<a href="ftell.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="ftell.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="ftell.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="ftell.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="ftell.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
