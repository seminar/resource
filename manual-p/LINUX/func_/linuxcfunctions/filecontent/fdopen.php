...
<title>fdopen函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">fdopen（将文件描述词转为文件指针）<br>
	相关函数 fopen，open，fclose<br>
	表头文件 #include&lt;stdio.h&gt;<br>
	定义函数 FILE * fdopen(int fildes,const char * mode);<br>
	函数说明 fdopen()会将参数fildes 的文件描述词，转换为对应的文件指针后返回。参数mode 
	字符串则代表着文件指针的流形态，此形态必须和原先文件描述词读写模式相同。关于mode 字符串格式请参考fopen()。<br>
	返回值 转换成功时返回指向该流的文件指针。失败则返回NULL，并把错误代码存在errno中。<br>
　</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="fdopen.php#" class="bds_more" data-cmd="more"></a>
	<a href="fdopen.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="fdopen.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="fdopen.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="fdopen.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="fdopen.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
