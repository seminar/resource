...
<title>setbuffer函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">setbuffer（设置文件流的缓冲区）<br>
	相关函数 setlinebuf，setbuf，setvbuf<br>
	表头文件 #include&lt;stdio.h&gt;<br>
	定义函数 void setbuffer(FILE * stream,char * buf,size_t size);<br>
	函数说明 在打开文件流后，读取内容之前，调用setbuffer()可用来设置文件流的缓冲区。参数stream为指定的文件流，参数buf指向自定的缓冲区起始地址，参数size为缓冲区大小。<br>
	返回值</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="setbuffer.php#" class="bds_more" data-cmd="more"></a>
	<a href="setbuffer.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="setbuffer.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="setbuffer.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="setbuffer.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="setbuffer.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
