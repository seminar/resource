...
<title>freopen函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">freopen（打开文件）<br>
	相关函数 fopen，fclose<br>
	表头文件 #include&lt;stdio.h&gt;<br>
	定义函数 FILE * freopen(const char * path,const char * mode,FILE *stream);<br>
	函数说明 参数path字符串包含欲打开的文件路径及文件名，参数mode请参考fopen()说明。参数stream为已打开的文件指针。Freopen()会将原stream所打开的文件流关闭，然后打开参数path的文件。<br>
	返回值 文件顺利打开后，指向该流的文件指针就会被返回。如果文件打开失败则返回NULL，并把错误代码存在errno 中。<br>
　</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="freopen.php#" class="bds_more" data-cmd="more"></a>
	<a href="freopen.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="freopen.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="freopen.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="freopen.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="freopen.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
