...
<title>fclose函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	...
	返回值 若关文件动作成功则返回0，有错误发生时则返回EOF并把错误代码<br>
	存到errno。<br>
	错误代码 EBADF表示参数stream非已打开的文件。</td>
	</tr>
</table>
　</td>
    <td background="../img_css/frame11.gif" width="14">　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="fclose.php#" class="bds_more" data-cmd="more"></a>
	<a href="fclose.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="fclose.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="fclose.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="fclose.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="fclose.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
