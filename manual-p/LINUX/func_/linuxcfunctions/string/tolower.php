...
<title>Linhan函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">tolower（将大写字母转换成小写字母）<br>
	相关函数 isalpha，toupper<br>
	表头文件 #include&lt;stdlib.h&gt;<br>
	定义函数 int tolower(int c);<br>
	函数说明 若参数c为大写字母则将该对应的小写字母返回。<br>
	返回值 返回转换后的小写字母，若不须转换则将参数c值返回。<br>
	附加说明<br>
　</td>
	</tr>
</table>
...
<tr><td align="right" width="398"> 
	<p align="left">范例:</p>
	<p align="left">/* 将s字符串内的大写字母转换成小写字母*/<br>
	#include&lt;ctype.h&gt;<br>
	main()<br>
	{<br>
	...
	执行 before tolower() : aBcDeFgH12345;!#$<br>
	after tolower() : abcdefgh12345;!#$</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="tolower.php#" class="bds_more" data-cmd="more"></a>
	<a href="tolower.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="tolower.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="tolower.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="tolower.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="tolower.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
