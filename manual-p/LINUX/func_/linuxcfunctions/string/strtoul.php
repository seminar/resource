...
<title>strtoul函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">strtoul（将字符串转换成无符号长整型数）<br>
	相关函数 atof，atoi，atol，strtod，strtol<br>
	表头文件 #include&lt;stdlib.h&gt;<br>
	定义函数 unsigned long int strtoul(const char *nptr,char<br>
	函数说明 strtoul()会将参数nptr字符串根据参数base来转换成无符号的长整<br>
	型数。参数base范围从2至36，或0。参数base代表采用的进制方<br>
	式，如base值为10则采用10进制，若base值为16则采用16进制数<br>
	等。当base值为0时则是采用10进制做转换，但遇到如'0x'前置字符<br>
	则会使用16进制做转换。一开始strtoul()会扫描参数nptr字符串，<br>
	跳过前面的空格字符串，直到遇上数字或正负符号才开始做转换，<br>
	再遇到非数字或字符串结束时('\0')结束转换，并将结果返回。若<br>
	参数endptr不为NULL，则会将遇到不合条件而终止的nptr中的字符<br>
	指针由endptr返回。<br>
	返回值 返回转换后的长整型数，否则返回ERANGE并将错误代码存入errno<br>
	中。<br>
	附加说明 ERANGE指定的转换字符串超出合法范围。</td>
	</tr>
</table>
　</td>
    <td background="../img_css/frame11.gif" width="14">　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="strtoul.php#" class="bds_more" data-cmd="more"></a>
	<a href="strtoul.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="strtoul.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="strtoul.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="strtoul.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="strtoul.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
