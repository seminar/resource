...
<title>toupper函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">toupper（将小写字母转换成大写字母）<br>
	相关函数 isalpha，tolower<br>
	表头文件 #include&lt;ctype.h&gt;<br>
	定义函数 int toupper(int c);<br>
	函数说明 若参数c为小写字母则将该对映的大写字母返回。<br>
	返回值 返回转换后的大写字母，若不须转换则将参数c值返回。<br>
	附加说明<br>
　</td>
	</tr>
</table>
...
<tr><td align="right" width="398"> 
	<p align="left">范例:</p>
	<p align="left">/* 将s字符串内的小写字母转换成大写字母*/<br>
	#include&lt;ctype.h&gt;<br>
	main()<br>
	{<br>
	...
	执行 before toupper() : aBcDeFgH12345;!#$<br>
	after toupper() : ABCDEFGH12345;!#$</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="toupper.php#" class="bds_more" data-cmd="more"></a>
	<a href="toupper.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="toupper.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="toupper.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="toupper.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="toupper.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
