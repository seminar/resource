...
<title>atoi函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">atoi（将字符串转换成整型数）<br>
	相关函数 atof，atol，atrtod，strtol，strtoul<br>
	表头文件 #include&lt;stdlib.h&gt;<br>
	定义函数 int atoi(const char *nptr);<br>
	函数说明 atoi()会扫描参数nptr字符串，跳过前面的空格字符，直到遇上数<br>
	字或正负符号才开始做转换，而再遇到非数字或字符串结束时<br>
	('\0')才结束转换，并将结果返回。<br>
	返回值 返回转换后的整型数。<br>
	附加说明 atoi()与使用strtol(nptr，(char**)NULL，10)；结果相同。<br>
　</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="atoi.php#" class="bds_more" data-cmd="more"></a>
	<a href="atoi.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="atoi.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="atoi.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="atoi.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="atoi.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
