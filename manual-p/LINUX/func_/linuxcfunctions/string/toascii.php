...
<title>toascii函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">toascii（将整型数转换成合法的ASCII 码字符）<br>
	相关函数 isascii，toupper，tolower<br>
	表头文件 #include&lt;ctype.h&gt;<br>
	定义函数 int toascii(int c)<br>
	函数说明 toascii()会将参数c转换成7位的unsigned char值，第八位则会被<br>
	清除，此字符即会被转成ASCII码字符。<br>
	返回值 将转换成功的ASCII码字符值返回。<br>
　</td>
	</tr>
</table>
　</td>
...
<tr><td align="right" width="398"> 
	...
	执行 before toascii() : a value =217()<br>
	after toascii() : a value =89(Y)</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="toascii.php#" class="bds_more" data-cmd="more"></a>
	<a href="toascii.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="toascii.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="toascii.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="toascii.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="toascii.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
