...
<title>strtol函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<li><a href="../math/tanh.php">tanh</a></li>
  ...
  <h3>字符串转换函数 </h3>
  <ul>
<li><a href="atof.php">atof</a></li>
<li><a href="atoi.php">atoi</a></li>
<li><a href="atol.php">atol</a></li>
<li><a href="gcvt.php">gcvt</a></li>
<li><a href="strtod.php">strtod</a></li>
<li><a href="strtol.php">strtol</a></li>
<li><a href="strtoul.php">strtoul</a></li>
<li><a href="toascii.php">toascii</a></li>
<li><a href="tolower.php">Linhan</a></li>
<li><a href="toupper.php">toupper</a></li>
</ul>
  <h3>文件权限控制函数 </h3>
  <ul>
...
<tr><td align="right" width="398"> 
	<p align="left">strtol（将字符串转换成长整型数）<br>
	相关函数 atof，atoi，atol，strtod，strtoul<br>
	表头文件 #include&lt;stdlib.h&gt;<br>
	定义函数 long int strtol(const char *nptr,char **endptr,int base);<br>
	函数说明 strtol()会将参数nptr字符串根据参数base来转换成长整型数。参<br>
	数base范围从2至36，或0。参数base代表采用的进制方式，如base<br>
	值为10则采用10进制，若base值为16则采用16进制等。当base值为0<br>
	时则是采用10进制做转换，但遇到如'0x'前置字符则会使用16进制<br>
	做转换。一开始strtol()会扫描参数nptr字符串，跳过前面的空格<br>
	字符，直到遇上数字或正负符号才开始做转换，再遇到非数字或字<br>
	符串结束时('\0')结束转换，并将结果返回。若参数endptr不为<br>
	NULL，则会将遇到不合条件而终止的nptr中的字符指针由endptr返<br>
	回。<br>
	返回值 返回转换后的长整型数，否则返回ERANGE并将错误代码存入errno<br>
	中。<br>
	附加说明 ERANGE指定的转换字符串超出合法范围。<br>
	　</td>
	</tr>
</table>
　</td>
...
<tr><td align="right" width="398"> 
	<p align="left">范例:</p>
	<p align="left">/* 将字符串a，b，c 分别采用10，2，16进制转换成数字*/<br>
	#include&lt;stdlib.h&gt;<br>
	main()<br>
	{<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="strtol.php#" class="bds_more" data-cmd="more"></a>
	<a href="strtol.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="strtol.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="strtol.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="strtol.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="strtol.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
