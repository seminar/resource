...
<title>gcvt函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">gcvt（将浮点型数转换为字符串，取四舍五入）<br>
	相关函数 ecvt，fcvt，sprintf<br>
	表头文件 #include&lt;stdlib.h&gt;<br>
	定义函数 char *gcvt(double number，size_t ndigits，char *buf);<br>
	函数说明 gcvt()用来将参数number转换成ASCII码字符串，参数ndigits表示<br>
	显示的位数。gcvt()与ecvt()和fcvt()不同的地方在于，gcvt()所<br>
	转换后的字符串包含小数点或正负符号。若转换成功，转换后的字<br>
	符串会放在参数buf指针所指的空间。<br>
	返回值 返回一字符串指针，此地址即为buf指针。<br>
	Untitled Document 页码，2/6<br>
	file://D:\linux_c\function\02.html 2004-1-9<br>
	附加说明<br>
　</td>
	</tr>
</table>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="gcvt.php#" class="bds_more" data-cmd="more"></a>
	<a href="gcvt.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="gcvt.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="gcvt.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="gcvt.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="gcvt.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
