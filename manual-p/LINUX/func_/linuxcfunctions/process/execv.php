...
<title>execv函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">execv（执行文件）<br>
	相关函数 fork，execl，execle，execlp，execve，execvp<br>
	表头文件 #include&lt;unistd.h&gt;<br>
	定义函数 int execv (const char * path, char * const argv[ ]);<br>
	函数说明 execv()用来执行参数path字符串所代表的文件路径，与execl()不同的地方在于execve()只需两个参数，第二个参数利用数组指针来传递给执行文件。<br>
...
<tr><td align="right" width="398"> 
	<p align="left">范例:</p>
	<p align="left">/* 执行/bin/ls -al /etc/passwd */<br>
	#include&lt;unistd.h&gt;<br>
	main()<br>
	{<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="execv.php#" class="bds_more" data-cmd="more"></a>
	<a href="execv.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="execv.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="execv.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="execv.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="execv.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
