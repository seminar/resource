...
<title>execvp函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">execvp（执行文件）<br>
	相关函数 fork，execl，execle，execlp，execv，execve<br>
	表头文件 #include&lt;unistd.h&gt;<br>
	定义函数 int execvp(const char *file ,char * const argv []);<br>
	函数说明 execvp()会从PATH 环境变量所指的目录中查找符合参数file 的文件名，找到后便执行该文件，然后将第二个参数argv传给该欲执行的文件。<br>
	返回值 如果执行成功则函数不会返回，执行失败则直接返回-1，失败原因存于errno中。<br>
	错误代码 请参考execve（）。<br>
	　</td>
	</tr>
</table>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="execvp.php#" class="bds_more" data-cmd="more"></a>
	<a href="execvp.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="execvp.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="execvp.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="execvp.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="execvp.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
