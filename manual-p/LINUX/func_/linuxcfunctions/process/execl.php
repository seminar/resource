...
<title>execl函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">execl（执行文件）<br>
	相关函数 fork，execle，execlp，execv，execve，execvp<br>
	表头文件 #include&lt;unistd.h&gt;<br>
	定义函数 int execl(const char * path,const char * arg,....);<br>
	函数说明 execl()用来执行参数path字符串所代表的文件路径，接下来的参数代表执行该文件时传递过去的argv(0)、argv[1]……，最后一个参数必须用空指针(NULL)作结束。<br>
...
<tr><td align="right" width="398"> 
	...
	main()<br>
	{<br>
	execl(“/bin/ls”,”ls”,”-al”,”/etc/passwd”,(char * )<br>
	0);<br>
	}<br>
	执行<br>
	/*执行/bin/ls -al /etc/passwd */<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="execl.php#" class="bds_more" data-cmd="more"></a>
	<a href="execl.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="execl.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="execl.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="execl.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="execl.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
