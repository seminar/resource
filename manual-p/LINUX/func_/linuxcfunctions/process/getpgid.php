...
<title>getpgid函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">getpgid（取得进程组识别码）<br>
	相关函数 setpgid，setpgrp，getpgrp<br>
	表头文件 #include&lt;unistd.h&gt;<br>
	定义函数 pid_t getpgid( pid_t pid);<br>
	函数说明 getpgid()用来取得参数pid 指定进程所属的组识别码。如果参数pid为0，则会取得目前进程的组识别码。<br>
	返回值 执行成功则返回组识别码，如果有错误则返回-1，错误原因存于errno中。<br>
	错误代码 ESRCH 找不到符合参数pid 指定的进程。<br>
　</td>
	</tr>
</table>
　</td>
...
<tr><td align="right" width="398"> 
	<p align="left">范例:</p>
	<p align="left">/*取得init 进程（pid＝1）的组识别码*/<br>
	#include&lt;unistd.h&gt;<br>
	mian()<br>
	{<br>
	printf(“init gid = %d\n”,getpgid(1));<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="getpgid.php#" class="bds_more" data-cmd="more"></a>
	<a href="getpgid.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="getpgid.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="getpgid.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="getpgid.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="getpgid.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
