...
<title>vsprintf函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="399"> 
	<p align="left">vsprintf（格式化字符串复制）<br>
	相关函数 vnsprintf，vprintf，snprintf<br>
	表头文件 #include&lt;stdio.h&gt;<br>
	定义函数 int vsprintf( char * str,const char * format,va_list ap);<br>
	函数说明 vsprintf()会根据参数format字符串来转换并格式化数据，然后将结果复制到参数str所指的字符串数组，直到出现字符串结束(’\0’)为止。关于参数format字符串的格式请参考printf()。<br>
	va_list用法请参考附录C或vprintf()范例。<br>
	返回值 成功则返回参数str字符串长度，失败则返回-1，错误原因存于errno中。<br>
	　</td>
	</tr>
</table>
　</td>
...
<tr><td align="right" width="398"> 
	<p align="left">范例:</p>
	<p align="left">请参考vprintf()及vsprintf()。</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="vsprintf.php#" class="bds_more" data-cmd="more"></a>
	<a href="vsprintf.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="vsprintf.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="vsprintf.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="vsprintf.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="vsprintf.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
