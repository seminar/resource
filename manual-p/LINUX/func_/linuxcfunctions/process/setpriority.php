...
<title>setpriority函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">setpriority（设置程序进程执行优先权）<br>
	相关函数 getpriority，nice<br>
	表头文件 #include&lt;sys/time.h&gt;<br>
	#include&lt;sys/resource.h&gt;<br>
	定义函数 int setpriority(int which,int who, int prio);<br>
	函数说明 setpriority()可用来设置进程、进程组和用户的进程执行优先权。<br>
	参数which有三种数值，参数who 则依which值有不同定义<br>
	which who 代表的意义<br>
	PRIO_PROCESS who为进程识别码<br>
	PRIO_PGRP who 为进程的组识别码<br>
	PRIO_USER who为用户识别码<br>
	参数prio介于-20 至20 之间。代表进程执行优先权，数值越低代表<br>
	有较高的优先次序，执行会较频繁。此优先权默认是0，而只有超级<br>
	用户（root）允许降低此值。<br>
	返回值 执行成功则返回0，如果有错误发生返回值则为-1，错误原因存于errno。<br>
	ESRCH 参数which或who 可能有错，而找不到符合的进程<br>
	EINVAL 参数which值错误。<br>
	EPERM 权限不够，无法完成设置<br>
	EACCES 一般用户无法降低优先权</td>
	</tr>
</table>
　</td>
    <td background="../img_css/frame11.gif" width="14">　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="setpriority.php#" class="bds_more" data-cmd="more"></a>
	<a href="setpriority.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="setpriority.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="setpriority.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="setpriority.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="setpriority.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
