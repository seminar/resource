...
<title>getpriority函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">getpriority（取得程序进程执行优先权）<br>
	相关函数 setpriority，nice<br>
	表头文件 #include&lt;sys/time.h&gt;<br>
	#include&lt;sys/resource.h&gt;<br>
	定义函数 int getpriority(int which,int who);<br>
	函数说明 getpriority()可用来取得进程、进程组和用户的进程执行优先权。<br>
	参数 which有三种数值，参数who 则依which值有不同定义<br>
	which who 代表的意义<br>
	PRIO_PROCESS who 为进程识别码<br>
	PRIO_PGRP who 为进程的组识别码<br>
	PRIO_USER who 为用户识别码<br>
	此函数返回的数值介于-20 至20之间，代表进程执行优先权，数值<br>
	越低代表有较高的优先次序，执行会较频繁。<br>
	返回值 返回进程执行优先权，如有错误发生返回值则为-1 且错误原因存于errno。<br>
	附加说明 由于返回值有可能是-1，因此要同时检查errno是否存有错误原因。<br>
	最好在调用次函数前先清除errno变量。<br>
	错误代码 ESRCH 参数which或who 可能有错，而找不到符合的进程。EINVAL参数which 值错误。<br>
	　</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="getpriority.php#" class="bds_more" data-cmd="more"></a>
	<a href="getpriority.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="getpriority.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="getpriority.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="getpriority.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="getpriority.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
