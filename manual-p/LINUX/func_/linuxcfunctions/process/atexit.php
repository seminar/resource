...
<title>atexit函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">atexit（设置程序正常结束前调用的函数）<br>
	相关函数 _exit,exit,on_exit<br>
	表头文件 #include&lt;stdlib.h&gt;<br>
	定义函数 int atexit (void (*function)(void));<br>
	函数说明 atexit()用来设置一个程序正常结束前调用的函数。当程序通过调用exit()或从main中返回时，参数function所指定的函数会先被调用，然后才真正由exit()结束程序。<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="atexit.php#" class="bds_more" data-cmd="more"></a>
	<a href="atexit.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="atexit.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="atexit.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="atexit.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="atexit.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
