...
<title>setpgrp函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">setpgrp（设置进程组识别码）<br>
	相关函数 getpgid，setpgid，getpgrp<br>
	表头文件 #include&lt;unistd.h&gt;<br>
	定义函数 int setpgrp(void);<br>
	函数说明 setpgrp()将目前进程所属的组识别码设为目前进程的进程识别码。<br>
	此函数相当于调用setpgid(0,0)。<br>
	返回值 执行成功则返回组识别码，如果有错误则返回-1，错误原因存于errno中。</td>
	</tr>
</table>
　</td>
    <td background="../img_css/frame11.gif" width="14">　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="setpgrp.php#" class="bds_more" data-cmd="more"></a>
	<a href="setpgrp.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="setpgrp.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="setpgrp.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="setpgrp.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="setpgrp.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
