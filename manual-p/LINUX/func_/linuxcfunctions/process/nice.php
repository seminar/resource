...
<title>nice函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">nice（改变进程优先顺序）<br>
	相关函数 setpriority，getpriority<br>
	表头文件 #include&lt;unistd.h&gt;<br>
	定义函数 int nice(int inc);<br>
	函数说明 nice()用来改变进程的进程执行优先顺序。参数inc数值越大则优先顺序排在越后面，即表示进程执行会越慢。只有超级用户才能使用负的inc 
	值，代表优先顺序排在前面，进程执行会较快。<br>
	返回值 如果执行成功则返回0，否则返回-1，失败原因存于errno中。<br>
	错误代码 EPERM 一般用户企图转用负的参数inc值改变进程优先顺序。</td>
	</tr>
</table>
　</td>
    <td background="../img_css/frame11.gif" width="14">　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="nice.php#" class="bds_more" data-cmd="more"></a>
	<a href="nice.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="nice.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="nice.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="nice.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="nice.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
