...
<title>sscanf函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">sscanf（格式化字符串输入）<br>
	相关函数 scanf，fscanf<br>
	表头文件 #include&lt;stdio.h&gt;<br>
	定义函数 int sscanf (const char *str,const char * format,........);<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="sscanf.php#" class="bds_more" data-cmd="more"></a>
	<a href="sscanf.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="sscanf.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="sscanf.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="sscanf.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="sscanf.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
