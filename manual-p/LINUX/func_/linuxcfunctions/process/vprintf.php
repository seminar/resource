...
<title>vprintf函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">vprintf（格式化输出数据）<br>
	相关函数 printf，vfprintf，vsprintf<br>
	表头文件 #include&lt;stdio.h&gt;<br>
	#include&lt;stdarg.h&gt;<br>
	定义函数 int vprintf(const char * format,va_list ap);<br>
	函数说明 vprintf()作用和printf()相同，参数format格式也相同。va_list为不定个数的参数列，用法及范例请参考附录C。<br>
...
<tr><td align="right" width="398"> 
	...
	执行 my_printf() : -100 3.14159 96<br>
	my_printf() : 150 150</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="vprintf.php#" class="bds_more" data-cmd="more"></a>
	<a href="vprintf.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="vprintf.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="vprintf.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="vprintf.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="vprintf.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
