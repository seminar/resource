...
<title>setpgid函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">setpgid（设置进程组识别码）<br>
	相关函数 getpgid，setpgrp，getpgrp<br>
	表头文件 #include&lt;unistd.h&gt;<br>
	定义函数 int setpgid(pid_t pid,pid_t pgid);<br>
	函数说明 setpgid()将参数pid 指定进程所属的组识别码设为参数pgid 指定的组识别码。如果参数pid 为0，则会用来设置目前进程的组识别码，如果参数pgid为0，则会以目前进程的进程识别码来取代。<br>
	返回值 执行成功则返回组识别码，如果有错误则返回-1，错误原因存于errno中。<br>
	错误代码 EINVAL 参数pgid小于0。<br>
	EPERM 进程权限不足，无法完成调用。<br>
	ESRCH 找不到符合参数pid指定的进程。<br>
	　</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="setpgid.php#" class="bds_more" data-cmd="more"></a>
	<a href="setpgid.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="setpgid.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="setpgid.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="setpgid.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="setpgid.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
