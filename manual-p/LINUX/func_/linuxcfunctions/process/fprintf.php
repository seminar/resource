...
<title>fprintf函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">fprintf（格式化输出数据至文件）<br>
	相关函数 printf，fscanf，vfprintf<br>
	表头文件 #include&lt;stdio.h&gt;<br>
	定义函数 int fprintf(FILE * stream, const char * format,.......);<br>
	函数说明 fprintf()会根据参数format字符串来转换并格式化数据，然后将结果输出到参数stream指定的文件中，直到出现字符串结束('\0')为止。<br>
	返回值 关于参数format字符串的格式请参考printf()。成功则返回实际输出的字符数，失败则返回-1，错误原因存于errno中。<br>
　</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="fprintf.php#" class="bds_more" data-cmd="more"></a>
	<a href="fprintf.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="fprintf.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="fprintf.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="fprintf.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="fprintf.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
