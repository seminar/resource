...
<title>wait函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">wait（等待子进程中断或结束）<br>
	相关函数 waitpid，fork<br>
	表头文件 #include&lt;sys/types.h&gt;<br>
	#include&lt;sys/wait.h&gt;<br>
	定义函数 pid_t wait (int * status);<br>
	函数说明 
	wait()会暂时停止目前进程的执行，直到有信号来到或子进程结束。如果在调用wait()时子进程已经结束，则wait()会立即返回子进程结束状态值。子进程的结束状态值会由参数status 
	返回，而子进程的进程识别码也会一快返回。如果不在意结束状态值，则参数 status可以设成NULL。子进程的结束状态值请参考waitpid()。<br>
...
<tr><td align="right" width="398"> 
	...
	执行 This is the child process.pid=1501<br>
	This is the parent process .wait for child...<br>
	child’s pid =1501,exit status =5</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="wait.php#" class="bds_more" data-cmd="more"></a>
	<a href="wait.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="wait.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="wait.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="wait.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="wait.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
