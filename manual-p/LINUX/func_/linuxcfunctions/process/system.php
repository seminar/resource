...
<title>system函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">system（执行shell 命令）<br>
	相关函数 fork，execve，waitpid，popen<br>
	表头文件 #include&lt;stdlib.h&gt;<br>
	定义函数 int system(const char * string);<br>
	函数说明 system()会调用fork()产生子进程，由子进程来调用/bin/sh-c<br>
	...
	用成功则最后会返回执行shell命令后的返回值，但是此返回值也有<br>
	可能为system()调用/bin/sh失败所返回的127，因此最好能再检查<br>
	errno 来确认执行成功。<br>
	附加说明 在编写具有SUID/SGID权限的程序时请勿使用system()，system()会<br>
...
<tr><td align="right" width="398"> 
	...
	-r--------- 1 root root 572 Sep 2 15 :34 /etc/shadow</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="system.php#" class="bds_more" data-cmd="more"></a>
	<a href="system.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="system.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="system.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="system.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="system.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
