...
<title>fscanf函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<img border="0" src="../img_css/line.JPG" width="406" height="7"></div>
  ...
  <tr> 
    <td background="../img_css/frame10.gif" width="12">　</td>
    <td>
<table width="414" border="0" align="center" class="space" id="table35">
<tr><td align="right" width="408"> 
	<p align="left">fscanf（格式化字符串输入）<br>
	相关函数 scanf，sscanf<br>
	表头文件 #include&lt;stdio.h&gt;<br>
	定义函数 int fscanf(FILE * stream ,const char *format,....);<br>
	函数说明 fscanf()会自参数stream的文件流中读取字符串，再根据参数format字符串来转换并格式化数据。格式转换形式请参考scanf()。<br>
	转换后的结构存于对应的参数内。<br>
...
<tr><td align="right" width="398"> 
	...
	执行 10 0x1b aaaaaaaaa bbbbbbbbbb /*从键盘输入*/<br>
	10 27 aaaaa<br>
	　</td>
	</tr>
</table>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="fscanf.php#" class="bds_more" data-cmd="more"></a>
	<a href="fscanf.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="fscanf.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="fscanf.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="fscanf.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="fscanf.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
