...
<title>on_exit函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">on_exit（设置程序正常结束前调用的函数）<br>
	相关函数 _exit，atexit，exit<br>
	表头文件 #include&lt;stdlib.h&gt;<br>
	定义函数 int on_exit(void (* function)(int, void*),void *arg);<br>
	函数说明 on_exit()用来设置一个程序正常结束前调用的函数。当程序通过调用exit()或从main中返回时，参数function所指定的函数会先被调用，然后才真正由exit()结束程序。参数arg指针会传给参数function函数，详细情况请见范例。<br>
	返回值 如果执行成功则返回0，否则返回-1，失败原因存于errno中。<br>
	附加说明<br>
　</td>
	</tr>
</table>
...
<tr><td align="right" width="398"> 
	<p align="left">范例:</p>
	<p align="left">范例 #include&lt;stdlib.h&gt;<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="on_exit.php#" class="bds_more" data-cmd="more"></a>
	<a href="on_exit.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="on_exit.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="on_exit.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="on_exit.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="on_exit.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
