...
<title>getopt函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">getopt（分析命令行参数）<br>
	相关函数<br>
	表头文件 #include&lt;unistd.h&gt;<br>
	定义函数 int getopt(int argc,char * const argv[ ],const char *<br>
	optstring);<br>
	函数说明 getopt()用来分析命令行参数。参数argc和argv是由main()传递的<br>
	参数个数和内容。参数optstring 则代表欲处理的选项字符串。此<br>
	函数会返回在argv 中下一个的选项字母，此字母会对应参数<br>
	optstring 中的字母。如果选项字符串里的字母后接着冒号“:”，<br>
	则表示还有相关的参数，全域变量optarg 即会指向此额外参数。如<br>
	果getopt()找不到符合的参数则会印出错信息，并将全域变量<br>
	optopt设为“?”字符，如果不希望getopt()印出错信息，则只要将<br>
	全域变量opterr设为0即可。<br>
	返回值 如果找到符合的参数则返回此参数字母，如果参数不包含在参数<br>
	optstring 的选项字母则返回“?”字符，分析结束则返回-1。</td>
	</tr>
</table>
　</td>
    <td background="../img_css/frame11.gif" width="14">　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="getopt.php#" class="bds_more" data-cmd="more"></a>
	<a href="getopt.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="getopt.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="getopt.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="getopt.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="getopt.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
