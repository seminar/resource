...
<title>ttyname函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">ttyname（返回一终端机名称）<br>
	相关函数 Isatty<br>
	表头文件 #include&lt;unistd.h&gt;<br>
	定义函数 char * ttyname(int desc);<br>
	函数说明 如果参数desc所代表的文件描述词为一终端机，则会将此终端机名<br>
	称由一字符串指针返回，否则返回NULL。<br>
	返回值 如果成功则返回指向终端机名称的字符串指针，有错误情况发生时<br>
	则返回NULL。<br>
　</td>
	</tr>
</table>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="ttyname.php#" class="bds_more" data-cmd="more"></a>
	<a href="ttyname.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="ttyname.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="ttyname.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="ttyname.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="ttyname.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
