...
<title>sinh函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">sinh（取双曲线正玄函数值）<br>
	相关函数 cosh，tanh<br>
	表头文件 #include&lt;math.h&gt;<br>
	定义函数 double sinh( double x);<br>
	函数说明 sinh()用来计算参数x的双曲线正玄值，然后将结果返回。数学定义<br>
	式为:(exp(x)-exp(-x))/2。<br>
	返回值 返回参数x的双曲线正玄值。<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="sinh.php#" class="bds_more" data-cmd="more"></a>
	<a href="sinh.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="sinh.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="sinh.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="sinh.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="sinh.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
