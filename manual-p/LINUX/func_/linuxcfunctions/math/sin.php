...
<title>sin函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">sin（取正玄函数值）<br>
	相关函数 acos，asin，atan，atan2，cos，tan<br>
	表头文件 #include&lt;math.h&gt;<br>
	定义函数 double sin(double x);<br>
	函数说明 sin（）用来计算参数x的正玄值，然后将结果返回。<br>
	返回值 返回-1 至1之间的计算结果。<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="sin.php#" class="bds_more" data-cmd="more"></a>
	<a href="sin.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="sin.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="sin.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="sin.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="sin.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
