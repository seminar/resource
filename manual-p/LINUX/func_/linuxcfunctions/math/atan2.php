...
<tr><td align="right" width="398"> 
	<p align="left">atan2（取得反正切函数值） <br>
	相关函数 acos，asin，atan，cos，sin，tan<br>
	表头文件 #include&lt;math.h&gt;<br>
	定义函数 double atan2(double y,double x);<br>
	函数说明 atan2()用来计算参数y/x的反正切值，然后将结果返回。<br>
	返回值 返回-PI/2 至PI/2 之间的计算结果。<br>
	附加说明 使用GCC编译时请加入-lm。<br>
	　</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="atan2.php#" class="bds_more" data-cmd="more"></a>
	<a href="atan2.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="atan2.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="atan2.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="atan2.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="atan2.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
