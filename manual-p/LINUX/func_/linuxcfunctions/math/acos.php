...
<title>acos函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">acos（取反余弦函数数值） <br>
	相关函数 asin , atan , atan2 , cos , sin , tan<br>
	表头文件 #include &lt;math.h&gt;<br>
	定义函数 double acos (double x);<br>
	函数说明 acos()用来计算参数x的反余弦值，然后将结果返回。参数x范围为－1至1之间，超过此范围则会失败。<br>
	返回值 返回0至PI之间的计算结果，单位为弧度，在函数库中角度均以弧度来表示。<br>
	错误代码 EDOM参数x超出范围。<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="acos.php#" class="bds_more" data-cmd="more"></a>
	<a href="acos.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="acos.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="acos.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="acos.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="acos.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
