...
<title>abs函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">abs（计算整型数的绝对值）<br>
	相关函数 labs, fabs<br>
	表头文件 #include&lt;stdlib.h&gt;<br>
	定义函数 int abs (int j)<br>
	函数说明 abs()用来计算参数j的绝对值，然后将结果返回。<br>
	返回值 返回参数j的绝对值结果。</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="abs.php#" class="bds_more" data-cmd="more"></a>
	<a href="abs.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="abs.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="abs.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="abs.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="abs.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
