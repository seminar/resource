...
<title>frexp函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<li><a href="atan2.php">atan2</a></li>
<li><a href="ceil.php">ceil</a></li>
<li><a href="cos.php">cos</a></li>
<li><a href="cosh.php">cosh</a></li>
<li><a href="exp.php">exp</a></li>
<li><a href="frexp.php">frexp</a></li>
<li><a href="ldexp.php">ldexp</a></li>
<li><a href="log.php">log</a></li>
<li><a href="log10.php">log10</a></li>
<li><a href="pow.php">pow</a></li>
<li><a href="sin.php">sin</a></li>
<li><a href="sinh.php">sinh</a></li>
<li><a href="sqrt.php">sqrt</a></li>
<li><a href="tan.php">tan</a></li>
<li><a href="tanh.php">tanh</a></li>
</ul>
  <h3>字符串转换函数 </h3>
  <ul>
...
<tr><td align="right" width="398"> 
	<p align="left">frexp（将浮点型数分为底数与指数）<br>
	相关函数 ldexp，modf<br>
	表头文件 #include&lt;math.h&gt;<br>
	定义函数 double frexp( double x, int *exp);<br>
	函数说明 frexp()用来将参数x 的浮点型数切割成底数和指数。底数部分直接<br>
	返回，指数部分则借参数exp 指针返回，将返回值乘以2 的exp次方<br>
	即为x的值。<br>
	返回值 返回参数x的底数部分，指数部分则存于exp指针所指的地址。<br>
	附加说明 使用GCC编译时请加入-lm。</td>
	</tr>
</table>
　</td>
    <td background="../img_css/frame11.gif" width="14">　</td>
...
<tr><td align="right" width="398"> 
	<p align="left">范例:</p>
	<p align="left">#include &lt;math.h&gt;<br>
	main()<br>
	{<br>
	int exp;<br>
	double fraction;<br>
	...
	执行 exp = 11<br>
	fraction = 0.500000 /* 0.5*(2^11)=1024*/</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="frexp.php#" class="bds_more" data-cmd="more"></a>
	<a href="frexp.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="frexp.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="frexp.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="frexp.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="frexp.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
