...
<title>bzero函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">bzero（将一段内存内容全清为零）<br>
	相关函数 memset，swab<br>
	表头文件 #include&lt;string.h&gt;<br>
	定义函数 void bzero(void *s,int n)；<br>
	函数说明 bzero()会将参数s所指的内存区域前n个字节，全部设为零值。相当于调用memset((void*)s,0,size_tn);<br>
	返回值<br>
	附加说明 建议使用memset取代 </td>
	</tr>
</table>
　</td>
    <td background="../img_css/frame11.gif" width="14">　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="bzero.php#" class="bds_more" data-cmd="more"></a>
	<a href="bzero.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="bzero.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="bzero.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="bzero.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="bzero.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
