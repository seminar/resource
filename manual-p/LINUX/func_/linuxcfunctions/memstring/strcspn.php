...
<title>strcspn函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">strcspn（返回字符串中连续不含指定字符串内容的字符数）<br>
	相关函数 strspn<br>
	表头文件 #inclued&lt;string.h&gt;<br>
	定义函数 size_t strcspn ( const char *s,const char * reject);<br>
	函数说明 strcspn()从参数s字符串的开头计算连续的字符，而这些字符都完全不在参数reject 所指的字符串中。简单地说，若strcspn()返回的数值为n，则代表字符串s开头连续有n个字符都不含字符串reject内的字符。<br>
	返回值 返回字符串s开头连续不含字符串reject内的字符数目。<br>
　</td>
	</tr>
</table>
　</td>
...
<tr><td align="right" width="398"> 
	...
	执行 5 /*只计算到“ ”的出现，所以返回“Linux”的长度*/<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="strcspn.php#" class="bds_more" data-cmd="more"></a>
	<a href="strcspn.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="strcspn.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="strcspn.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="strcspn.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="strcspn.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
