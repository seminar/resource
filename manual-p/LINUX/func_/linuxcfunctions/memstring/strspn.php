...
<title>strspn函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">strspn（返回字符串中连续不含指定字符串内容的字符数）<br>
	相关函数 strcspn，strchr，strpbrk，strsep，strstr<br>
	表头文件 #include&lt;string.h&gt;<br>
	定义函数 size_t strspn (const char *s,const char *accept);<br>
	函数说明 strspn()从参数s 字符串的开头计算连续的字符，而这些字符都完全是accept 所指字符串中的字符。简单的说，若strspn()返回的数值为n，则代表字符串s 
	开头连续有n 个字符都是属于字符串accept内的字符。<br>
	返回值 返回字符串s开头连续包含字符串accept内的字符数目。<br>
　</td>
	</tr>
</table>
　</td>
...
<tr><td align="right" width="398"> 
	...
	main()<br>
	{<br>
	char *str=&quot;Linux was first developed for 386/486-based<br>
	PCs.&quot;;<br>
	char<br>
	*t1=&quot;abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ&quot;;<br>
	printf(&quot;%d\n&quot;,strspn(str,t1));<br>
	}<br>
	执行 5 /*计算大小写字母。不包含“ ”，所以返回Linux的长度。*/<br>
	　</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="strspn.php#" class="bds_more" data-cmd="more"></a>
	<a href="strspn.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="strspn.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="strspn.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="strspn.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="strspn.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
