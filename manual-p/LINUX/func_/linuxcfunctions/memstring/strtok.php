...
<title>strtok函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<img border="0" src="../img_css/line.JPG" width="406" height="7"></div>
  ...
  <tr> 
    <td background="../img_css/frame10.gif" width="12">　</td>
    <td>
<table width="401" border="0" align="center" class="space" id="table35">
<tr><td align="right" width="395"> 
	<p align="left">strtok（分割字符串）<br>
	相关函数 index，memchr，rindex，strpbrk，strsep，strspn，strstr<br>
	...
	字符。在第一次调用时，strtok()必需给予参数s字符串，往后的调用则将参数s设置成NULL。每次调用成功则返回下一个分割后的字符串指针。<br>
...
<tr><td align="right" width="398"> 
	...
	执行 ab cd ef;gh i jkl;mnop;qrs tu vwx y;z /*－与:字符已经被\0字符取代*/<br>
	　</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="strtok.php#" class="bds_more" data-cmd="more"></a>
	<a href="strtok.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="strtok.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="strtok.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="strtok.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="strtok.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
