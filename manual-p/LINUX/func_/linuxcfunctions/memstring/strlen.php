...
<title>strlen函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">strlen（返回字符串长度）<br>
	相关函数<br>
	表头文件 #include&lt;string.h&gt;<br>
	定义函数 size_t strlen (const char *s);<br>
	函数说明 strlen()用来计算指定的字符串s的长度，不包括结束字符&quot;\0&quot;。<br>
	返回值 返回字符串s的字符数。<br>
	　</td>
	</tr>
</table>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="strlen.php#" class="bds_more" data-cmd="more"></a>
	<a href="strlen.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="strlen.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="strlen.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="strlen.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="strlen.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
