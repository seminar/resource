...
<title>strcpy函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<img border="0" src="../img_css/line.JPG" width="406" height="7"></div>
  ...
  <tr> 
    <td background="../img_css/frame10.gif" width="12">　</td>
    <td>
<table width="405" border="0" align="center" class="space" id="table35">
<tr><td align="right" width="399"> 
	<p align="left">strcpy（拷贝字符串）<br>
	相关函数 bcopy，memcpy，memccpy，memmove<br>
	表头文件 #include&lt;string.h&gt;<br>
	定义函数 char *strcpy(char *dest,const char *src);<br>
	函数说明 strcpy()会将参数src字符串拷贝至参数dest所指的地址。<br>
	返回值 返回参数dest的字符串起始地址。<br>
	附加说明 如果参数dest所指的内存空间不够大，可能会造成缓冲溢出(buffer Overflow)的错误情况，在编写程序时请特别留意，或者用strncpy()来取代。<br>
　</td>
	</tr>
</table>
　</td>
...
<tr><td align="right" width="398"> 
	...
	执行 before strcpy() :string(1)<br>
	after strcpy() :string(2)</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="strcpy.php#" class="bds_more" data-cmd="more"></a>
	<a href="strcpy.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="strcpy.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="strcpy.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="strcpy.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="strcpy.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
