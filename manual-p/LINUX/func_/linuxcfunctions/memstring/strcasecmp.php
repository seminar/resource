...
<title>strcasecmp函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<img border="0" src="../img_css/line.JPG" width="406" height="7"></div>
  ...
  <tr> 
    <td background="../img_css/frame10.gif" width="12">　</td>
    <td>
<table width="403" border="0" align="center" class="space" id="table35">
<tr><td align="right" width="397"> 
	<p align="left">strcasecmp（忽略大小写比较字符串）<br>
	相关函数 bcmp，memcmp，strcmp，strcoll，strncmp<br>
	表头文件 #include&lt;string.h&gt;<br>
	定义函数 int strcasecmp (const char *s1, const char *s2);<br>
	函数说明 strcasecmp()用来比较参数s1和s2字符串，比较时会自动忽略大小写的差异。<br>
	返回值 若参数s1和s2字符串相同则返回0。s1长度大于s2长度则返回大于0的值，s1 长度若小于s2 长度则返回小于0的值。<br>
　</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="strcasecmp.php#" class="bds_more" data-cmd="more"></a>
	<a href="strcasecmp.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="strcasecmp.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="strcasecmp.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="strcasecmp.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="strcasecmp.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
