...
<title>strcmp函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">strcmp（比较字符串）<br>
	相关函数 bcmp，memcmp，strcasecmp，strncasecmp，strcoll<br>
	表头文件 #include&lt;string.h&gt;<br>
	定义函数 int strcmp(const char *s1,const char *s2);<br>
	函数说明 strcmp()用来比较参数s1和s2字符串。字符串大小的比较是以ASCII码表上的顺序来决定，此顺序亦为字符的值。strcmp()首先将s1第一个字符值减去s2第一个字符值，若差值为0则再继续比较下个字符，若差值不为0则将差值返回。例如字符串&quot;Ac&quot;和&quot;ba&quot;比较则会返回字符&quot;A&quot;(65)和'b'(98)的差值(－33)。<br>
	返回值 若参数s1和s2字符串相同则返回0。s1若大于s2则返回大于0的值。<br>
	s1若小于s2则返回小于0 的值。<br>
　</td>
	</tr>
</table>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="strcmp.php#" class="bds_more" data-cmd="more"></a>
	<a href="strcmp.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="strcmp.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="strcmp.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="strcmp.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="strcmp.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
