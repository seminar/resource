...
<title>strstr函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">strstr（在一字符串中查找指定的字符串）<br>
	相关函数 index，memchr，rindex，strchr，strpbrk，strsep，strspn，strtok<br>
	表头文件 #include&lt;string.h&gt;<br>
	定义函数 char *strstr(const char *haystack,const char *needle);<br>
	函数说明 strstr()会从字符串haystack 中搜寻字符串needle，并将第一次出现的地址返回。<br>
	返回值 返回指定字符串第一次出现的地址，否则返回0。<br>
　</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="strstr.php#" class="bds_more" data-cmd="more"></a>
	<a href="strstr.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="strstr.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="strstr.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="strstr.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="strstr.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
