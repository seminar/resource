...
<title>strcoll函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">strcoll（采用目前区域的字符排列次序来比较字符串）<br>
	相关函数 strcmp，bcmp，memcmp，strcasecmp，strncasecmp<br>
	表头文件 #include&lt;string.h&gt;<br>
	定义函数 int strcoll( const char *s1, const char *s2);<br>
	函数说明 strcoll()会依环境变量LC_COLLATE所指定的文字排列次序来比较s1和s2 字符串。<br>
	返回值 若参数s1和s2字符串相同则返回0。s1若大于s2则返回大于0的值。<br>
	s1若小于s2则返回小于0 的值。<br>
	附加说明 若LC_COLLATE为&quot;POSIX&quot;或&quot;C&quot;，则strcoll()与strcmp()作用完全相同。<br>
	　</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="strcoll.php#" class="bds_more" data-cmd="more"></a>
	<a href="strcoll.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="strcoll.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="strcoll.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="strcoll.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="strcoll.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
