...
<title>memccpy函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">memccpy（拷贝内存内容）<br>
	相关函数 bcopy，memcpy，memmove，strcpy，strncpy<br>
	表头文件 #include&lt;string.h&gt;<br>
	定义函数 void * memccpy(void *dest, const void * src, int c,size_tn);<br>
	函数说明 memccpy()用来拷贝src所指的内存内容前n个字节到dest所指的地址上。与memcpy()不同的是，memccpy()会在复制时检查参数c是否出现，若是则返回dest中值为c的下一个字节地址。<br>
	返回值 返回指向dest中值为c的下一个字节指针。返回值为0表示在src所指内存前n个字节中没有值为c的字节。<br>
　</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="memccpy.php#" class="bds_more" data-cmd="more"></a>
	<a href="memccpy.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="memccpy.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="memccpy.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="memccpy.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="memccpy.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
