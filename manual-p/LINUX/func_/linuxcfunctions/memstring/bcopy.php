...
<title>bcopy函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<img border="0" src="../img_css/line.JPG" width="406" height="7"></div>
  ...
  <tr> 
    <td background="../img_css/frame10.gif" width="12">　</td>
    <td>
<table width="409" border="0" align="center" class="space" id="table35">
<tr><td align="right" width="403"> 
	<p align="left">bcopy（拷贝内存内容）<br>
	相关函数 memccpy，memcpy，memmove，strcpy，ctrncpy<br>
	表头文件 #include &lt;string.h&gt;<br>
	定义函数 void bcopy ( const void *src,void *dest ,int n);<br>
	函数说明 bcopy()与memcpy()一样都是用来拷贝src所指的内存内容前n个字节<br>
	到dest所指的地址，不过参数src与dest在传给函数时是相反的位置。<br>
	返回值<br>
	附加说明 建议使用memcpy()取代<br>
　</td>
	</tr>
</table>
　</td>
...
<tr><td align="right" width="398"> 
	...
	int i;<br>
	bcopy(src,dest,30);/* src指针放在前*/<br>
	printf(bcopy(): “)<br>
	for(i=0;i&lt;30;i++)<br>
	printf(“%c”,dest[i]);<br>
	memcpy(dest src,30); /*dest指针放在钱*/<br>
	printf(‘\nmemcpy() : “);<br>
	for(i=0;i&lt;30;i++)<br>
	printf(“%c”,dest[i]);<br>
	执行 bcopy() : string string<br>
	memcpy() :string sring</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="bcopy.php#" class="bds_more" data-cmd="more"></a>
	<a href="bcopy.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="bcopy.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="bcopy.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="bcopy.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="bcopy.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
