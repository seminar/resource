...
<title>memchr函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">memchr（在某一内存范围中查找一特定字符）<br>
	相关函数 index，rindex，strchr，strpbrk，strrchr，strsep，strspn，strstr<br>
	表头文件 #include&lt;string.h&gt;<br>
	定义函数 void * memchr(const void *s,int c,size_t n);<br>
	函数说明 memchr()从头开始搜寻s所指的内存内容前n个字节，直到发现第一个值为c的字节，则返回指向该字节的指针。<br>
	返回值 如果找到指定的字节则返回该字节的指针，否则返回0。<br>
　</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="memchr.php#" class="bds_more" data-cmd="more"></a>
	<a href="memchr.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="memchr.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="memchr.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="memchr.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="memchr.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
