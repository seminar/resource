...
<title>strncat函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<img border="0" src="../img_css/line.JPG" width="406" height="7"></div>
  ...
  <tr> 
    <td background="../img_css/frame10.gif" width="12">　</td>
    <td>
<table width="431" border="0" align="center" class="space" id="table35">
<tr><td align="right" width="425"> 
	<p align="left">strncat（连接两字符串）<br>
	相关函数 bcopy，memccpy，memecpy，strcpy，strncpy<br>
	表头文件 #inclue &lt;string.h&gt;<br>
	定义函数 char * strncat(char *dest,const char *src,size_t n);<br>
	函数说明 strncat()会将参数src字符串拷贝n个字符到参数dest所指的字符串尾。第一个参数dest要有足够的空间来容纳要拷贝的字符串。<br>
...
<tr><td align="right" width="398"> 
	...
	执行 before strnact() : string(1)<br>
	after strncat() : string(1) string</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="strncat.php#" class="bds_more" data-cmd="more"></a>
	<a href="strncat.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="strncat.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="strncat.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="strncat.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="strncat.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
