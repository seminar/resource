...
<title>strcat函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">strcat（连接两字符串）<br>
	相关函数 bcopy，memccpy，memcpy，strcpy，strncpy<br>
	表头文件 #include &lt;string.h&gt;<br>
	定义函数 char *strcat (char *dest,const char *src);<br>
	函数说明 strcat()会将参数src字符串拷贝到参数dest所指的字符串尾。第一个参数dest要有足够的空间来容纳要拷贝的字符串。<br>
...
<tr><td align="right" width="398"> 
	...
	执行 before strcat () : string(1)<br>
	after strcat () : string(1)string(2)</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="strcat.php#" class="bds_more" data-cmd="more"></a>
	<a href="strcat.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="strcat.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="strcat.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="strcat.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="strcat.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
