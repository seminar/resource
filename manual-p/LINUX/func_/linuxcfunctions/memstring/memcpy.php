...
<title>memcpy函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">memcpy（拷贝内存内容）<br>
	相关函数 bcopy，memccpy，memcpy，memmove，strcpy，strncpy<br>
	表头文件 #include&lt;string.h&gt;<br>
	定义函数 void * memcpy (void * dest ,const void *src, size_t n);<br>
	函数说明 memcpy()用来拷贝src所指的内存内容前n个字节到dest所指的内存地址上。与strcpy()不同的是，memcpy()会完整的复制n个字节，不会因为遇到字符串结束'\0'而结束。<br>
	返回值 返回指向dest的指针。<br>
	附加说明 指针src和dest所指的内存区域不可重叠。<br>
　</td>
	</tr>
</table>
　</td>
...
<tr><td align="right" width="398"> 
	...
	执行 strcpy() : string a )<br>
	memcpy() : string string</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="memcpy.php#" class="bds_more" data-cmd="more"></a>
	<a href="memcpy.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="memcpy.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="memcpy.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="memcpy.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="memcpy.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
