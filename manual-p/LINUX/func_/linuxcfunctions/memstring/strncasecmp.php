...
<title>strncasecmp函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">strncasecmp（忽略大小写比较字符串）<br>
	相关函数 bcmp，memcmp，strcmp，strcoll，strncmp<br>
	表头文件 #include&lt;string.h&gt;<br>
	定义函数 int strncasecmp(const char *s1,const char *s2,size_t n);<br>
	函数说明 strncasecmp()用来比较参数s1和s2字符串前n个字符，比较时会自动忽略大小写的差异。<br>
	返回值 若参数s1和s2 字符串相同则返回0。s1 若大于s2则返回大于0的值，s1若小于s2则返回小于0 的值。<br>
	<br>
	　</td>
	</tr>
</table>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="strncasecmp.php#" class="bds_more" data-cmd="more"></a>
	<a href="strncasecmp.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="strncasecmp.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="strncasecmp.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="strncasecmp.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="strncasecmp.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
