...
<title>memcmp函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<li><a href="../algorithm/srand.php">srand</a></li>
  ...
  <h3>内存和字符串函数</h3>
  <ul>
<li><a href="bcmp.php">bcmp</a></li>
<li><a href="bcopy.php">bcopy</a></li>
<li><a href="bzero.php">bzero</a></li>
<li><a href="index.php">index</a></li>
<li><a href="memccpy.php">memccpy</a></li>
<li><a href="memchr.php">memchr</a></li>
<li><a href="memcmp.php">memcmp</a></li>
<li><a href="memcpy.php">memcpy</a></li>
<li><a href="memmove.php">memmove</a></li>
<li><a href="memset.php">memset</a></li>
<li><a href="rindex.php">rindex</a></li>
<li><a href="strcasecmp.php">strcasecmp</a></li>
<li><a href="strcat.php">strcat</a></li>
<li><a href="strchr.php">strchr</a></li>
<li><a href="strcmp.php">strcmp</a></li>
<li><a href="strcoll.php">strcoll</a></li>
<li><a href="strcpy.php">strcpy</a></li>
<li><a href="strcspn.php">strcspn</a></li>
<li><a href="strdup.php">strdup</a></li>
<li><a href="strlen.php">strlen</a></li>
<li><a href="strncasecmp.php">strncasecmp</a></li>
<li><a href="strncat.php">strncat</a></li>
<li><a href="strncpy.php">strncpy</a></li>
<li><a href="strpbrk.php">strpbrk</a></li>
<li><a href="strrchr.php">strrchr</a></li>
<li><a href="strspn.php">strspn</a></li>
<li><a href="strstr.php">strstr</a></li>
<li><a href="strtok.php">strtok</a></li>
</ul>
</div><div class="c_m">
...
<tr><td align="right" width="398"> 
	<p align="left">memcmp（比较内存内容）<br>
	相关函数 bcmp，strcasecmp，strcmp，strcoll，strncmp，strncasecmp<br>
	表头文件 #include&lt;string.h&gt;<br>
	定义函数 int memcmp (const void *s1,const void *s2,size_t n);<br>
	函数说明 memcmp()用来比较s1和s2所指的内存区间前n个字符。字符串大小的比较是以ASCII码表上的顺序来决定，次顺序亦为字符的值。memcmp()首先将s1第一个字符值减去s2第一个字符的值，若差为0则再继续比较下个字符，若差值不为0则将差值返回。例如，字符<br>
	串&quot;Ac&quot;和&quot;ba&quot;比较则会返回字符'A'(65)和'b'(98)的差值(－33)。<br>
	返回值 若参数s1和s2所指的内存内容都完全相同则返回0值。s1若大于s2则返回大于0的值。s1若小于s2则返回小于0的值。<br>
　</td>
	</tr>
</table>
　</td>
...
<tr><td align="right" width="398"> 
	...
	执行 memcmp(a,b):1 /*字符串a&gt;字符串b，返回1*/<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="memcmp.php#" class="bds_more" data-cmd="more"></a>
	<a href="memcmp.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="memcmp.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="memcmp.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="memcmp.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="memcmp.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
