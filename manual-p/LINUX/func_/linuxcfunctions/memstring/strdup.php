...
<title>strdup函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">strdup（复制字符串）<br>
	相关函数 calloc，malloc，realloc，free<br>
	表头文件 #include&lt;string.h&gt;<br>
	定义函数 char * strdup( const char *s);<br>
	函数说明 strdup()会先用maolloc()配置与参数s字符串相同的空间大小，然后将参数s字符串的内容复制到该内存地址，然后把该地址返回。该地址最后可以利用free()来释放。<br>
	返回值 返回一字符串指针，该指针指向复制后的新字符串地址。若返回NULL表示内存不足。<br>
　</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="strdup.php#" class="bds_more" data-cmd="more"></a>
	<a href="strdup.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="strdup.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="strdup.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="strdup.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="strdup.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
