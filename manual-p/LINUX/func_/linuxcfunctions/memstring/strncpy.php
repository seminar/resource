...
<title>strncpy函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">strncpy（拷贝字符串）<br>
	相关函数 bcopy，memccpy，memcpy，memmove<br>
	表头文件 #include&lt;string.h&gt;<br>
	定义函数 char * strncpy(char *dest,const char *src,size_t n);<br>
	函数说明 strncpy()会将参数src字符串拷贝前n个字符至参数dest所指的地址。<br>
...
<tr><td align="right" width="398"> 
	<p align="left">范例:</p>
	<p align="left">#inclue &lt;string.h&gt;<br>
	main()<br>
	{<br>
	...
	执行 before strncpy() : string(1)<br>
	after strncpy() : string(1)</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="strncpy.php#" class="bds_more" data-cmd="more"></a>
	<a href="strncpy.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="strncpy.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="strncpy.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="strncpy.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="strncpy.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
