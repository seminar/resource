...
<title>memset函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">memset（将一段内存空间填入某值）<br>
	相关函数 bzero，swab<br>
	表头文件 #include&lt;string.h&gt;<br>
	定义函数 void * memset (void *s ,int c, size_t n);<br>
	函数说明 memset()会将参数s所指的内存区域前n个字节以参数c填入，然后返回指向s的指针。在编写程序时，若需要将某一数组作初始化，memset()会相当方便。<br>
	返回值 返回指向s的指针。<br>
	附加说明 参数c虽声明为int， 但必须是unsigned char ，所以范围在0到255之间。<br>
　</td>
	</tr>
</table>
　</td>
...
<tr><td align="right" width="398"> 
	...
	执行 AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="memset.php#" class="bds_more" data-cmd="more"></a>
	<a href="memset.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="memset.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="memset.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="memset.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="memset.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
