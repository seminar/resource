...
<title>bcmp函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<img border="0" src="../img_css/line.JPG" width="406" height="7"></div>
  ...
  <tr> 
    <td background="../img_css/frame10.gif" width="12">　</td>
    <td>
<table width="417" border="0" align="center" class="space" id="table35">
<tr><td align="right" width="411"> 
	<p align="left">bcmp（比较内存内容）<br>
	相关函数 bcmp，strcasecmp，strcmp，strcoll，strncmp，strncasecmp<br>
	表头文件 #include&lt;string.h&gt;<br>
	定义函数 int bcmp ( const void *s1,const void * s2,int n);<br>
	函数说明 bcmp()用来比较s1和s2所指的内存区间前n个字节，若参数n为0，则返回0。<br>
	返回值 若参数s1 和s2 所指的内存内容都完全相同则返回0 值，否则返回非零值。<br>
	附加说明 建议使用memcmp()取代。<br>
　</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="bcmp.php#" class="bds_more" data-cmd="more"></a>
	<a href="bcmp.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="bcmp.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="bcmp.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="bcmp.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="bcmp.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
