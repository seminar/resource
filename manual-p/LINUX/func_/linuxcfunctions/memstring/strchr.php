...
<title>strchr函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">strchr（查找字符串中第一个出现的指定字符）<br>
	相关函数 index，memchr，rinex，strbrk，strsep，strspn，strstr，strtok<br>
	表头文件 #include&lt;string.h&gt;<br>
	定义函数 char * strchr (const char *s,int c);<br>
	函数说明 strchr()用来找出参数s字符串中第一个出现的参数c地址，然后将该字符出现的地址返回。<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="strchr.php#" class="bds_more" data-cmd="more"></a>
	<a href="strchr.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="strchr.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="strchr.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="strchr.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="strchr.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
