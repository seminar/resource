...
<title>strpbrk函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<img border="0" src="../img_css/line.JPG" width="406" height="7"></div>
  ...
  <tr> 
    <td background="../img_css/frame10.gif" width="12">　</td>
    <td>
<table width="404" border="0" align="center" class="space" id="table35">
<tr><td align="right" width="398"> 
	<p align="left">strpbrk（查找字符串中第一个出现的指定字符）<br>
	相关函数 index，memchr，rindex，strpbrk，strsep，strspn，strstr，strtok<br>
	表头文件 #include &lt;include.h&gt;<br>
	定义函数 char *strpbrk(const char *s,const char *accept);<br>
	函数说明 strpbrk()用来找出参数s 字符串中最先出现存在参数accept 字符串中的任意字符。<br>
	返回值 如果找到指定的字符则返回该字符所在地址，否则返回0。<br>
　</td>
	</tr>
</table>
　</td>
...
<tr><td align="right" width="398"> 
	...
	char *p;<br>
	p=strpbrk(s,&quot;a1 839&quot;); /*1会最先在s字符串中找到*/<br>
	printf(&quot;%s\n&quot;,p);<br>
	p=strprk(s,&quot;4398&quot;);/*3 会最先在s 字符串中找到*/<br>
	printf(&quot;%s\n&quot;,p);<br>
	执行 1.23E+29<br>
	　</td>
	</tr>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="strpbrk.php#" class="bds_more" data-cmd="more"></a>
	<a href="strpbrk.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="strpbrk.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="strpbrk.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="strpbrk.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="strpbrk.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
