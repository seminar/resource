...
<title>islower函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">islower（测试字符是否为小写字母）<br>
	相关函数 isalpha，isupper<br>
	表头文件 #include&lt;ctype.h&gt;<br>
	定义函数 int islower(int c)<br>
	函数说明 检查参数c是否为小写英文字母。<br>
	返回值 若参数c为小写英文字母，则返回TRUE，否则返回NULL(0)。<br>
	附加说明 此为宏定义，非真正函数。<br>
　</td>
	</tr>
</table>
...
<tr><td align="right" width="398"> 
	<p align="left">范例:</p>
	<p align="left">#include&lt;ctype.h&gt;<br>
	main()<br>
	{<br>
	char str[]=&quot;123@#FDsP[e?&quot;;<br>
	int i;<br>
	for(i=0;str[i]!=0;i++)<br>
	if(islower(str[i])) printf(&quot;%c is a lower-case<br>
	character\n&quot;,str[i]);<br>
	}<br>
	执行 c is a lower-case character<br>
	s is a lower-case character<br>
	e is a lower-case character</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="islower.php#" class="bds_more" data-cmd="more"></a>
	<a href="islower.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="islower.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="islower.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="islower.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="islower.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
