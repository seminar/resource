...
<title>isascii函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<h3>字符测试函数 </h3>
  <ul>
<li><a href="isalnum.php">isalnum</a></li>
<li><a href="isalpha.php">isalpha</a></li>
<li><a href="isascii.php">isascii</a></li>
<li><a href="isdigit.php">isdigit</a></li>
<li><a href="isgraphis.php">isgraphis</a></li>
<li><a href="islower.php">islower</a></li>
<li><a href="isprint.php">isprint</a></li>
<li><a href="ispunct.php">ispunct</a></li>
<li><a href="isspace.php">isspace</a></li>
<li><a href="isupper.php">isupper</a></li>
<li><a href="isxdigit.php">isxdigit</a></li>
</ul>
  <h3>接口处理函数 </h3>
  <ul>
...
<tr><td align="right" width="398"> 
	<p align="left">isascii（测试字符是否为ASCII 码字符）<br>
	相关函数 iscntrl<br>
	表头文件 #include &lt;ctype.h&gt;<br>
	定义函数 int isascii(int c);<br>
	函数说明 检查参数c是否为ASCII码字符，也就是判断c的范围是否在0到127之<br>
	间。<br>
	返回值 若参数c为ASCII码字符，则返回TRUE，否则返回NULL(0)。<br>
	附加说明 此为宏定义，非真正函数。<br>
　</td>
	</tr>
</table>
...
<tr><td align="right" width="398"> 
	<p align="left">范例:</p>
	<p align="left">/* 判断int i是否具有对映的ASCII码字符*/<br>
	#include&lt;ctype.h&gt;<br>
	main()<br>
	{<br>
	int i;<br>
	...
	执行 125 is an ascii character:}<br>
	126 is an ascii character:~<br>
	127 is an ascii character:<br>
	128 is not an ascii character<br>
	129 is not an ascii character<br>
	iscntrl（测试字符是否为ASCII 码的控制字符）<br>
	相关函数 isascii<br>
	表头文件 #include &lt;ctype.h&gt;<br>
	定义函数 int iscntrl(int c)；<br>
	函数说明 检查参数c是否为ASCII控制码，也就是判断c的范围是否在0到30之<br>
	间。<br>
	返回值 若参数c为ASCII控制码，则返回TRUE，否则返回NULL(0)。<br>
	附加说明 此为宏定义，非真正函数。</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="isascii.php#" class="bds_more" data-cmd="more"></a>
	<a href="isascii.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="isascii.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="isascii.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="isascii.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="isascii.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
