...
<title>isgraphis函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">isgraphis（测试字符是否为可打印字符）<br>
	相关函数 isprint<br>
	表头文件 #include &lt;ctype.h&gt;<br>
	定义函数 int isgraph (int c)<br>
	函数说明 检查参数c是否为可打印字符，若c所对映的ASCII码可打印，且非空<br>
	格字符则返回TRUE。<br>
	返回值 若参数c为可打印字符，则返回TRUE，否则返回NULL(0)。<br>
	附加说明 此为宏定义，非真正函数。<br>
　</td>
	</tr>
</table>
...
<tr><td align="right" width="398"> 
	<p align="left">范例:</p>
	<p align="left">/* 判断str字符串中哪些为可打印字符*/<br>
	#include&lt;ctype.h&gt;<br>
	main()<br>
	{<br>
	char str[]=&quot;a5 @;&quot;;<br>
	...
	if(isgraph(str[i])) printf(&quot;str[%d] is printable<br>
	character:%d\n&quot;,i,str[i]);<br>
	}<br>
	执行 str[0] is printable character:a<br>
	str[1] is printable character:5<br>
	str[3] is printable character:@<br>
	str[4] is printable character:;</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="isgraphis.php#" class="bds_more" data-cmd="more"></a>
	<a href="isgraphis.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="isgraphis.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="isgraphis.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="isgraphis.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="isgraphis.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
