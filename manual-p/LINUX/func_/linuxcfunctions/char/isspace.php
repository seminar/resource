...
<title>isspace函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">isspace（测试字符是否为空格字符）<br>
	相关函数 isgraph<br>
	表头文件 #include&lt;ctype.h&gt;<br>
	定义函数 int isspace(int c)<br>
	函数说明 检查参数c是否为空格字符，也就是判断是否为空格('')、定位字符<br>
	('\t')、CR('\r')、换行('\n')、垂直定位字符('\v')或翻页<br>
	('\f')的情况。<br>
	返回值 若参数c为空格字符，则返回TRUE，否则返回NULL(0)。<br>
	附加说明 此为宏定义，非真正函数。<br>
　</td>
	</tr>
</table>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <tr> 
    ...
    <td width="474">
<table width="424" border="0" align="center" class="space" id="table45">
<tr><td align="right" width="418"> 
	<p align="left">范例:</p>
	<p align="left">/*将字符串str[]中内含的空格字符找出，并显示空格字符的ASCII码*/<br>
	#include &lt;ctype.h&gt;<br>
	main()<br>
	{<br>
	...
	执行 str[4] is a white-space character:32<br>
	str[7] is a white-space character:32<br>
	str[10] is a white-space character:9 /* \t */<br>
	str[16] is a white-space character:10 /* \t */</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="isspace.php#" class="bds_more" data-cmd="more"></a>
	<a href="isspace.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="isspace.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="isspace.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="isspace.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="isspace.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
