...
<title>isprint函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">isprint（测试字符是（否为可打印字符）<br>
	相关函数 isgraph<br>
	表头文件 #include&lt;ctype.h&gt;<br>
	定义函数 int isprint(int c);<br>
	函数说明 检查参数c是否为可打印字符，若c所对映的ASCII码可打印，其中包<br>
	含空格字符，则返回TRUE。<br>
...
<tr><td align="right" width="398"> 
	<p align="left">范例:</p>
	<p align="left">/* 判断str字符串中哪些为可打印字符包含空格字符*/<br>
	#include&lt;ctype.h&gt;<br>
	main()<br>
	{<br>
	char str[]=&quot;a5 @;&quot;;<br>
	...
	if(isprint(str[i])) printf(&quot;str[%d] is printable<br>
	character:%d\n&quot;,i,str[i]);<br>
	}<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="isprint.php#" class="bds_more" data-cmd="more"></a>
	<a href="isprint.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="isprint.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="isprint.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="isprint.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="isprint.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
