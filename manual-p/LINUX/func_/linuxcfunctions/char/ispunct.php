...
<title>ispunct函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">ispunct（测试字符是否为标点符号或特殊符号）<br>
	相关函数 isspace，isdigit，isalpha<br>
	表头文件 #inlude&lt;ctype.h&gt;<br>
	定义函数 int ispunct(int c)<br>
	函数说明 检查参数c是否为标点符号或特殊符号。返回TRUE也就是代表参数c<br>
	为非空格、非数字和非英文字母。<br>
	返回值 v若参数c为标点符号或特殊符号，则返回TRUE，否则返回NULL(0)。<br>
	附加说明 此为宏定义，非真正函数。<br>
	　</td>
	</tr>
</table>
...
<tr><td align="right" width="398"> 
	<p align="left">范例:</p>
	<p align="left">/*列出字符串str中的标点符号或特殊符号*/<br>
	#include &lt;ctype.h&gt;<br>
	main()<br>
	{<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="ispunct.php#" class="bds_more" data-cmd="more"></a>
	<a href="ispunct.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="ispunct.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="ispunct.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="ispunct.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="ispunct.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
