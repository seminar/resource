...
<title>alphasort函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">alphasort（依字母顺序排序目录结构）<br>
	相关函数 scandir，qsort<br>
	表头文件 #include&lt;dirent.h&gt;<br>
	定义函数 int alphasort(const struct dirent **a,const struct dirent<br>
	**b);<br>
	函数说明 alphasort()为scandir()最后调用qsort()函数时传给qsort()作为<br>
	判断的函数，详细说明请参考scandir()及qsort()。<br>
	返回值 参考qsort()。<br>
　</td>
	</tr>
</table>
...
<tr><td align="right" width="398"> 
	<p align="left">范例:</p>
	<p align="left">/* 读取/目录下所有的目录结构，并依字母顺序排列*/<br>
	main()<br>
	{<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="alphasort.php#" class="bds_more" data-cmd="more"></a>
	<a href="alphasort.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="alphasort.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="alphasort.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="alphasort.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="alphasort.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
