...
<title>utimes函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="399"> 
	<p align="left">utimes（修改文件的存取时间和更改时间）<br>
	相关函数 utime，stat<br>
	表头文件 #include&lt;sys/types.h&gt;<br>
	#include&lt;utime.h&gt;<br>
	定义函数 int utimes(char * filename.struct timeval *tvp);<br>
	函数说明 utimes()用来修改参数filename文件所属的inode存取时间和修改时间。<br>
	结构timeval定义如下<br>
	struct timeval {<br>
	long tv_sec;<br>
	long tv_usec; /* 微妙*/<br>
	};<br>
	返回值 参数tvp 指向两个timeval 结构空间，和utime（）使用的utimebuf结构比较，tvp[0].tc_sec 
	则为utimbuf.actime，tvp]1].tv_sec为utimbuf.modtime。<br>
	执行成功则返回0。失败返回-1，错误代码存于errno。<br>
	错误代码 EACCESS 存取文件时被拒绝，权限不足<br>
	ENOENT 指定的文件不存在</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="utimes.php#" class="bds_more" data-cmd="more"></a>
	<a href="utimes.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="utimes.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="utimes.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="utimes.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="utimes.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
