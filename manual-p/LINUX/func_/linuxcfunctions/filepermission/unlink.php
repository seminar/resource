...
<title>unlink函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">unlink（删除文件）<br>
	相关函数 link，rename，remove<br>
	表头文件 #include&lt;unistd.h&gt;<br>
	定义函数 int unlink(const char * pathname);<br>
	函数说明 
	unlink()会删除参数pathname指定的文件。如果该文件名为最后连接点，但有其他进程打开了此文件，则在所有关于此文件的文件描述词皆关闭后才会删除。如果参数pathname为一符号连接，则此连接会被删除。<br>
	返回值 成功则返回0，失败返回-1，错误原因存于errno<br>
	错误代码 EROFS 文件存在于只读文件系统内<br>
	EFAULT 参数pathname指针超出可存取内存空间<br>
	ENAMETOOLONG 参数pathname太长<br>
	ENOMEM 核心内存不足<br>
	ELOOP 参数pathname 有过多符号连接问题<br>
	EIO I/O 存取错误</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="unlink.php#" class="bds_more" data-cmd="more"></a>
	<a href="unlink.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="unlink.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="unlink.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="unlink.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="unlink.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
