...
<title>fchdir函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">fchdir（改变当前的工作目录）<br>
	相关函数 getcwd，chroot<br>
	表头文件 #include&lt;unistd.h&gt;<br>
	定义函数 int fchdir(int fd);<br>
	函数说明 fchdir()用来将当前的工作目录改变成以参数fd 所指的文件描述<br>
	词。<br>
	返回值执 行成功则返回0，失败返回-1，errno为错误代码。<br>
	附加说明<br>
　</td>
	</tr>
</table>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="fchdir.php#" class="bds_more" data-cmd="more"></a>
	<a href="fchdir.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="fchdir.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="fchdir.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="fchdir.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="fchdir.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
