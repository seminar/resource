...
<title>opendir函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">opendir（打开目录）<br>
	相关函数 open，readdir，closedir，rewinddir，seekdir，telldir，scandir<br>
	表头文件 #include&lt;sys/types.h&gt;<br>
	#include&lt;dirent.h&gt;<br>
	定义函数 DIR * opendir(const char * name);<br>
	函数说明 opendir()用来打开参数name指定的目录，并返回DIR*形态的目录流，和open()类似，接下来对目录的读取和搜索都要使用此返回值。<br>
	返回值 成功则返回DIR* 型态的目录流，打开失败则返回NULL。<br>
	错误代码 EACCESS 权限不足<br>
	EMFILE 已达到进程可同时打开的文件数上限。<br>
	ENFILE 已达到系统可同时打开的文件数上限。<br>
	ENOTDIR 参数name非真正的目录<br>
	ENOENT 参数name 指定的目录不存在，或是参数name 为一空字符<br>
	串。<br>
	ENOMEM 核心内存不足。</td>
	</tr>
</table>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="opendir.php#" class="bds_more" data-cmd="more"></a>
	<a href="opendir.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="opendir.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="opendir.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="opendir.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="opendir.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
