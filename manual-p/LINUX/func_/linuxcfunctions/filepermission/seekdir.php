...
<title>seekdir函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">seekdir（设置下回读取目录的位置）<br>
	相关函数 open，opendir，closedir，rewinddir，telldir，readdir，<br>
	scandir<br>
	表头文件 #include&lt;dirent.h&gt;<br>
	定义函数 void seekdir(DIR * dir,off_t offset);<br>
	函数说明 seekdir()用来设置参数dir目录流目前的读取位置，在调用readdir<br>
	()时便从此新位置开始读取。参数offset 代表距离目录文件开头的<br>
	偏移量。<br>
	返回值<br>
	错误代码 EBADF 参数dir为无效的目录流<br>
　</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="seekdir.php#" class="bds_more" data-cmd="more"></a>
	<a href="seekdir.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="seekdir.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="seekdir.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="seekdir.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="seekdir.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
