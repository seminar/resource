...
<title>chroot函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">chroot（改变根目录）<br>
	相关函数 chdir<br>
	表头文件 #include&lt;unistd.h&gt;<br>
	定义函数 int chroot(const char * path);<br>
	函数说明 chroot()用来改变根目录为参数path 所指定的目录。只有超级用户<br>
	才允许改变根目录，子进程将继承新的根目录。<br>
	返回值 调用成功则返回0，失败则返-1，错误代码存于errno。<br>
	错误代码 EPERM 权限不足，无法改变根目录。<br>
...
<tr><td align="right" width="398"> 
	<p align="left">范例:</p>
	<p align="left">/* 将根目录改为/tmp ,并将工作目录切换至/tmp */<br>
	#include&lt;unistd.h&gt;<br>
	main()<br>
	{<br>
	chroot(“/tmp”);<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="chroot.php#" class="bds_more" data-cmd="more"></a>
	<a href="chroot.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="chroot.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="chroot.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="chroot.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="chroot.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
