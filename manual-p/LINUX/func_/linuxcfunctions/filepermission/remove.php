...
<title>remove函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">remove（删除文件）<br>
	相关函数 link，rename，unlink<br>
	表头文件 #include&lt;stdio.h&gt;<br>
	定义函数 int remove(const char * pathname);<br>
	函数说明 
	remove()会删除参数pathname指定的文件。如果参数pathname为一文件，则调用unlink()处理，若参数pathname为一目录，则调用rmdir()来处理。请参考unlink()与rmdir()。<br>
	返回值 成功则返回0，失败则返回-1，错误原因存于errno。<br>
	错误代码 EROFS 欲写入的文件存在于只读文件系统内<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="remove.php#" class="bds_more" data-cmd="more"></a>
	<a href="remove.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="remove.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="remove.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="remove.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="remove.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
