...
<title>ftruncate函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">ftruncate（改变文件大小）<br>
	相关函数 open，truncate<br>
	表头文件 #include&lt;unistd.h&gt;<br>
	定义函数 int ftruncate(int fd,off_t length);<br>
	函数说明 ftruncate()会将参数fd指定的文件大小改为参数length指定的大小。参数fd为已打开的文件描述词，而且必须是以写入模式打开的文件。如果原来的文件大小比参数length大，则超过的部分会被删去。<br>
	返回值 执行成功则返回0，失败返回-1，错误原因存于errno。<br>
	错误代码 EBADF 参数fd文件描述词为无效的或该文件已关闭。<br>
	EINVAL 参数fd 为一socket 并非文件，或是该文件并非以写入模式<br>
	打开。</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="ftruncate.php#" class="bds_more" data-cmd="more"></a>
	<a href="ftruncate.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="ftruncate.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="ftruncate.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="ftruncate.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="ftruncate.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
