...
<title>closedir函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">closedir（关闭目录）<br>
	相关函数 opendir<br>
	表头文件 #include&lt;sys/types.h&gt;<br>
	#include&lt;dirent.h&gt;<br>
	定义函数 int closedir(DIR *dir);<br>
	函数说明 closedir()关闭参数dir所指的目录流。<br>
	返回值 关闭成功则返回0，失败返回-1，错误原因存于errno 中。<br>
	错误代码 EBADF 参数dir为无效的目录流</td>
	</tr>
</table>
　</td>
    <td background="../img_css/frame11.gif" width="14">　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="closedir.php#" class="bds_more" data-cmd="more"></a>
	<a href="closedir.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="closedir.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="closedir.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="closedir.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="closedir.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
