...
<title>chmod函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">chmod（改变文件的权限）<br>
	相关函数 fchmod，stat，open，chown<br>
	表头文件 #include&lt;sys/types.h&gt;<br>
	#include&lt;sys/stat.h&gt;<br>
	定义函数 int chmod(const char * path,mode_t mode);<br>
	函数说明 chmod()会依参数mode 权限来更改参数path 指定文件的权限。<br>
	参数 mode 有下列数种组合<br>
	...
	只有该文件的所有者或有效用户识别码为0，才可以修改该文件权<br>
	限。基于系统安全，如果欲将数据写入一执行文件，而该执行文件<br>
	具有S_ISUID 或S_ISGID 权限，则这两个位会被清除。如果一目录<br>
	具有S_ISUID 位权限，表示在此目录下只有该文件的所有者或root<br>
	可以删除该文件。<br>
	返回值 权限改变成功返回0，失败返回-1，错误原因存于errno。<br>
	错误代码 EPERM 进程的有效用户识别码与欲修改权限的文件拥有者不同，而<br>
	且也不具root权限。<br>
...
<tr><td align="right" width="398"> 
	<p align="left">范例:</p>
	<p align="left">/* 将/etc/passwd 文件权限设成<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="chmod.php#" class="bds_more" data-cmd="more"></a>
	<a href="chmod.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="chmod.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="chmod.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="chmod.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="chmod.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
