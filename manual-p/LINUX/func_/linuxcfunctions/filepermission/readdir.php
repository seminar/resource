...
<title>readdir函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">readdir（读取目录）<br>
	相关函数 open，opendir，closedir，rewinddir，seekdir，telldir，scandir<br>
	表头文件 #include &lt;sys/types.h&gt;<br>
	#include &lt;dirent.h&gt;<br>
	定义函数 struct dirent * readdir(DIR * dir);<br>
	函数说明 readdir()返回参数dir目录流的下个目录进入点。<br>
	结构dirent定义如下<br>
	struct dirent<br>
	{<br>
	ino_t d_ino;<br>
	...
	d_ino 此目录进入点的inode<br>
	d_off 目录文件开头至此目录进入点的位移<br>
	d_reclen _name的长度，不包含NULL字符<br>
	d_type d_name 所指的文件类型<br>
	d_name 文件名<br>
	返回值 成功则返回下个目录进入点。有错误发生或读取到目录文件尾则返回NULL。<br>
	附加说明 EBADF参数dir为无效的目录流。<br>
　</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="readdir.php#" class="bds_more" data-cmd="more"></a>
	<a href="readdir.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="readdir.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="readdir.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="readdir.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="readdir.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
