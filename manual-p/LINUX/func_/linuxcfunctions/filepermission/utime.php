...
<title>utime函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<img border="0" src="../img_css/line.JPG" width="406" height="7"></div>
  ...
  <tr> 
    <td background="../img_css/frame10.gif" width="12">　</td>
    <td>
<table width="421" border="0" align="center" class="space" id="table35">
<tr><td align="right" width="415"> 
	<p align="left">utime（修改文件的存取时间和更改时间）<br>
	相关函数 utimes，stat<br>
	表头文件 #include&lt;sys/types.h&gt;<br>
	#include&lt;utime.h&gt;<br>
	定义函数 int utime(const char * filename,struct utimbuf * buf);<br>
	函数说明 utime()用来修改参数filename文件所属的inode存取时间。<br>
	结构utimbuf定义如下<br>
	struct utimbuf{<br>
	time_t actime;<br>
	time_t modtime;<br>
	};<br>
	返回值 如果参数buf为空指针(NULL)，则该文件的存取时间和更改时间全部会设为目前时间。<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="utime.php#" class="bds_more" data-cmd="more"></a>
	<a href="utime.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="utime.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="utime.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="utime.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="utime.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
