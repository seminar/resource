...
<title>fstat函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">fstat（由文件描述词取得文件状态）<br>
	相关函数 stat，lstat，chmod，chown，readlink，utime<br>
	表头文件 #include&lt;sys/stat.h&gt;<br>
	#include&lt;unistd.h&gt;<br>
	定义函数 int fstat(int fildes,struct stat *buf);<br>
	函数说明 fstat()用来将参数fildes所指的文件状态，复制到参数buf所指的<br>
	结构中(struct stat)。Fstat()与stat()作用完全相同，不同处在<br>
	于传入的参数为已打开的文件描述词。详细内容请参考stat()。<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="fstat.php#" class="bds_more" data-cmd="more"></a>
	<a href="fstat.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="fstat.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="fstat.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="fstat.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="fstat.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
