...
<tr><td align="right" width="398"> 
	<p align="left">chdir（改变当前的工作（目录）<br>
	相关函数 getcwd，chroot<br>
	表头文件 #include&lt;unistd.h&gt;<br>
	定义函数 int chdir(const char * path);<br>
	函数说明 chdir()用来将当前的工作目录改变成以参数path所指的目录。<br>
	返回值 执行成功则返回0，失败返回-1，errno为错误代码。<br>
　</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="chdir.php#" class="bds_more" data-cmd="more"></a>
	<a href="chdir.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="chdir.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="chdir.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="chdir.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="chdir.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
