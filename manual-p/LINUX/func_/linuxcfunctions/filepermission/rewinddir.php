...
<title>rewinddir函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">rewinddir（重设读取目录的位置为开头位置）<br>
	相关函数 open，opendir，closedir，telldir，seekdir，readdir，scandir<br>
	表头文件 #include&lt;sys/types.h&gt;<br>
	#include&lt;dirent.h&gt;<br>
	定义函数 void rewinddir(DIR *dir);<br>
	函数说明 rewinddir()用来设置参数dir 目录流目前的读取位置为原来开头的<br>
	读取位置。<br>
	返回值<br>
	错误代码 EBADF dir为无效的目录流<br>
　</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="rewinddir.php#" class="bds_more" data-cmd="more"></a>
	<a href="rewinddir.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="rewinddir.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="rewinddir.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="rewinddir.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="rewinddir.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
