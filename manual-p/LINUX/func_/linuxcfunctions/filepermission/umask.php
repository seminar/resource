...
<title>umask函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">umask（设置建立新文件时的权限遮罩）<br>
	相关函数 creat，open<br>
	表头文件 #include&lt;sys/types.h&gt;<br>
	#include&lt;sys/stat.h&gt;<br>
	定义函数 mode_t umask(mode_t mask);<br>
	函数说明 umask()会将系统umask值设成参数mask&amp;0777后的值，然后将先前的umask值返回。在使用open()建立新文件时，该参数mode并非真正建立文件的权限，而是(mode&amp;~umask)的权限值。例如，在建立文件时指定文件权限为0666，通常umask值默认为022，则该文件的真正权限则为0666&amp;～022＝0644，也就是rw-r--r--返回值此调用不会有错误值返回。<p align="left">
	返回值为原先系统的umask值。</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="umask.php#" class="bds_more" data-cmd="more"></a>
	<a href="umask.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="umask.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="umask.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="umask.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="umask.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
