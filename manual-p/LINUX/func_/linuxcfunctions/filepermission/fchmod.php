...
<title>fchmod函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">fchmod（改变文件的权限）<br>
	相关函数 chmod，stat，open，chown<br>
	表头文件 #include&lt;sys/types.h&gt;<br>
	#include&lt;sys/stat.h&gt;<br>
	定义函数 int fchmod(int fildes,mode_t mode);<br>
	函数说明 fchmod()会依参数mode权限来更改参数fildes所指文件的权限。参<br>
	数fildes为已打开文件的文件描述词。参数mode请参考chmod（）。<br>
	返回值 权限改变成功则返回0，失败返回-1，错误原因存于errno。<br>
	错误原因 EBADF 参数fildes为无效的文件描述词。<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="fchmod.php#" class="bds_more" data-cmd="more"></a>
	<a href="fchmod.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="fchmod.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="fchmod.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="fchmod.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="fchmod.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
