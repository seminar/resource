...
<title>chown函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">chown（改变文件的所有者）<br>
	相关函数 fchown，lchown，chmod<br>
	表头文件 #include&lt;sys/types.h&gt;<br>
	#include&lt;unistd.h&gt;<br>
	定义函数 int chown(const char * path, uid_t owner,gid_t group);<br>
	函数说明 chown()会将参数path指定文件的所有者变更为参数owner代表的用<br>
	户，而将该文件的组变更为参数group组。如果参数owner或group<br>
	为-1，对应的所有者或组不会有所改变。root与文件所有者皆可改<br>
	变文件组，但所有者必须是参数group组的成员。当root用chown()<br>
	改变文件所有者或组时，该文件若具有S_ISUID或S_ISGID权限，则<br>
	会清除此权限位，此外如果具有S_ISGID权限但不具S_IXGRP位，则<br>
	该文件会被强制锁定，文件模式会保留。<br>
...
<tr><td align="right" width="398"> 
	<p align="left">范例:</p>
	<p align="left">/* 将/etc/passwd 的所有者和组都设为root */<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="chown.php#" class="bds_more" data-cmd="more"></a>
	<a href="chown.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="chown.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="chown.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="chown.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="chown.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
