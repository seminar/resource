...
<title>telldir函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">telldir（取得目录流的读取位置）<br>
	相关函数 open，opendir，closedir，rewinddir，seekdir，readdir，<br>
	scandir<br>
	表头文件 #include&lt;dirent.h&gt;<br>
	定义函数 off_t telldir(DIR *dir);<br>
	函数说明 telldir()返回参数dir目录流目前的读取位置。此返回值代表距离<br>
	目录文件开头的偏移量返回值返回下个读取位置，有错误发生时返<br>
	回-1。<br>
	错误代码 EBADF参数dir为无效的目录流。<br>
　</td>
	</tr>
</table>
　</td>
...
<tr><td align="right" width="398"> 
	...
	d_name:rc.sysinit offset :4096</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="telldir.php#" class="bds_more" data-cmd="more"></a>
	<a href="telldir.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="telldir.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="telldir.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="telldir.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="telldir.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
