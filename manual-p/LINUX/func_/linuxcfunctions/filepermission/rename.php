...
<title>rename函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">rename（更改文件名称或位置）<br>
	相关函数 link，unlink，symlink<br>
	表头文件 #include&lt;stdio.h&gt;<br>
	定义函数 int rename(const char * oldpath,const char * newpath);<br>
	函数说明 rename()会将参数oldpath 所指定的文件名称改为参数newpath所指<br>
	的文件名称。若newpath所指定的文件已存在，则会被删除。<br>
...
<tr><td align="right" width="398"> 
	<p align="left">范例:</p>
	<p align="left">/* 设计一个DOS下的rename指令rename 旧文件名新文件名*/<br>
	#include &lt;stdio.h&gt;<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="rename.php#" class="bds_more" data-cmd="more"></a>
	<a href="rename.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="rename.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="rename.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="rename.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="rename.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
