...
<title>write函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">write（将数据写入已打开的文件内）<br>
	相关函数 open，read，fcntl，close，lseek，sync，fsync，fwrite<br>
	表头文件 #include&lt;unistd.h&gt;<br>
	定义函数 ssize_t write (int fd,const void * buf,size_t count);<br>
	函数说明 write()会把参数buf所指的内存写入count个字节到参数fd所指的文<br>
	件内。当然，文件读写位置也会随之移动。<br>
	返回值 如果顺利write()会返回实际写入的字节数。当有错误发生时则返<br>
	回-1，错误代码存入errno中。<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="write.php#" class="bds_more" data-cmd="more"></a>
	<a href="write.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="write.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="write.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="write.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="write.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
