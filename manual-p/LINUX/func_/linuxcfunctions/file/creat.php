...
<title>creat函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">creat（建立文件）<br>
	相关函数 read，write，fcntl，close，link，stat，umask，unlink，fopen<br>
	表头文件 #include&lt;sys/types.h&gt;<br>
	#include&lt;sys/stat.h&gt;<br>
	#include&lt;fcntl.h&gt;<br>
	定义函数 int creat(const char * pathname, mode_tmode);<br>
	函数说明 参数pathname指向欲建立的文件路径字符串。Creat()相当于使用下<br>
	列的调用方式调用open()<br>
	open(const char * pathname ,(O_CREAT|O_WRONLY|O_TRUNC));<br>
	错误代码 关于参数mode请参考open（）函数。<br>
	返回值 creat()会返回新的文件描述词，若有错误发生则会返回-1，并把错<br>
	误代码设给errno。<br>
	...
	附加说明 creat()无法建立特别的装置文件，如果需要请使用mknod()。<br>
　</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="creat.php#" class="bds_more" data-cmd="more"></a>
	<a href="creat.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="creat.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="creat.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="creat.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="creat.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
