...
<title>close函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">close（关闭文件）<br>
	相关函数 open，fcntl，shutdown，unlink，fclose<br>
	表头文件 #include&lt;unistd.h&gt;<br>
	定义函数 int close(int fd);<br>
	函数说明 当使用完文件后若已不再需要则可使用close()关闭该文件，二<br>
	close()会让数据写回磁盘，并释放该文件所占用的资源。参数fd为<br>
	先前由open()或creat()所返回的文件描述词。<br>
	返回值 若文件顺利关闭则返回0，发生错误时返回-1。<br>
	错误代码 EBADF 参数fd 非有效的文件描述词或该文件已关闭。<br>
	附加说明 虽然在进程结束时，系统会自动关闭已打开的文件，但仍建议自行<br>
	关闭文件，并确实检查返回值。</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="close.php#" class="bds_more" data-cmd="more"></a>
	<a href="close.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="close.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="close.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="close.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="close.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
