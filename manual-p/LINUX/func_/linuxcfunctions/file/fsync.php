...
<title>fsync函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">fsync（将缓冲区数据写回磁盘）<br>
	相关函数 sync<br>
	表头文件 #include&lt;unistd.h&gt;<br>
	定义函数 int fsync(int fd);<br>
	函数说明 fsync()负责将参数fd所指的文件数据，由系统缓冲区写回磁盘，以<br>
	确保数据同步。<br>
	返回值 成功则返回0，失败返回-1，errno为错误代码。</td>
	</tr>
</table>
　</td>
    <td background="../img_css/frame11.gif" width="14">　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="fsync.php#" class="bds_more" data-cmd="more"></a>
	<a href="fsync.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="fsync.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="fsync.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="fsync.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="fsync.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
