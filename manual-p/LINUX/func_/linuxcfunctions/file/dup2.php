...
<title>adup2函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">adup2（复制文件描述词）<br>
	相关函数 open，close，fcntl，dup<br>
	表头文件 #include&lt;unistd.h&gt;<br>
	定义函数 int dup2(int odlfd,int newfd);<br>
	函数说明 dup2()用来复制参数oldfd所指的文件描述词，并将它拷贝至参数<br>
	newfd后一块返回。若参数newfd为一已打开的文件描述词，则newfd<br>
	所指的文件会先被关闭。dup2()所复制的文件描述词，与原来的文<br>
	件描述词共享各种文件状态，详情可参考dup()。<br>
	返回值 当复制成功时，则返回最小及尚未使用的文件描述词。若有错误则<br>
	返回-1，errno会存放错误代码。<br>
	附加说明 dup2()相当于调用fcntl(oldfd，F_DUPFD，newfd)；请参考fcntl<br>
	()。<br>
	错误代码 EBADF 参数fd 非有效的文件描述词，或该文件已关闭</td>
	</tr>
</table>
　</td>
    <td background="../img_css/frame11.gif" width="14">　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="dup2.php#" class="bds_more" data-cmd="more"></a>
	<a href="dup2.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="dup2.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="dup2.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="dup2.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="dup2.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
