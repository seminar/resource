...
<title>dup函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">dup（复制文件描述词）<br>
	相关函数 open，close，fcntl，dup2<br>
	表头文件 #include&lt;unistd.h&gt;<br>
	定义函数 int dup (int oldfd);<br>
	函数说明 dup()用来复制参数oldfd所指的文件描述词，并将它返回。此新的<br>
	文件描述词和参数oldfd指的是同一个文件，共享所有的锁定、读写<br>
	位置和各项权限或旗标。例如，当利用lseek()对某个文件描述词作<br>
	用时，另一个文件描述词的读写位置也会随着改变。不过，文件描<br>
	述词之间并不共享close-on-exec旗标。<br>
	返回值 当复制成功时，则返回最小及尚未使用的文件描述词。若有错误则<br>
	返回-1，errno会存放错误代码。错误代码EBADF参数fd非有效的文<br>
	件描述词，或该文件已关闭。</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="dup.php#" class="bds_more" data-cmd="more"></a>
	<a href="dup.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="dup.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="dup.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="dup.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="dup.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
