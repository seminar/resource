...
<title>mkstemp函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">mkstemp（建立唯一的临时文件）<br>
	相关函数 mktemp<br>
	表头文件 #include&lt;stdlib.h&gt;<br>
	定义函数 int mkstemp(char * template);<br>
	函数说明 mkstemp()用来建立唯一的临时文件。参数template 所指的文件名<br>
	称字符串中最后六个字符必须是XXXXXX。Mkstemp()会以可读写模式<br>
	和0600 权限来打开该文件，如果该文件不存在则会建立该文件。打<br>
	开该文件后其文件描述词会返回。文件顺利打开后返回可读写的文<br>
	件描述词。若果文件打开失败则返回NULL，并把错误代码存在errno<br>
	中。<br>
	错误代码 EINVAL 参数template 字符串最后六个字符非XXXXXX。EEXIST 无法<br>
	建立临时文件。<br>
...
<tr><td align="right" width="398"> 
	...
	执行 template = template-lgZcbo<br>
	　</p></td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="mkstemp.php#" class="bds_more" data-cmd="more"></a>
	<a href="mkstemp.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="mkstemp.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="mkstemp.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="mkstemp.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="mkstemp.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
