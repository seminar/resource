...
<title>setprotoent函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">setprotoent（打开网络协议的数据文件）<br>
	相关函数 getprotobyname, getprotobynumber, endprotoent<br>
	表头文件 #include &lt;netdb.h&gt;<br>
	定义函数 void setprotoent (int stayopen);<br>
	函数说明 setprotoent()用来打开/etc/protocols， 如果参数stayopen值为1，则接下来的getprotobyname()或getprotobynumber()将不会自动关闭此文件。</td>
	</tr>
</table>
　</td>
    <td background="../img_css/frame11.gif" width="14">　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="setprotoent.php#" class="bds_more" data-cmd="more"></a>
	<a href="setprotoent.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="setprotoent.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="setprotoent.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="setprotoent.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="setprotoent.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
