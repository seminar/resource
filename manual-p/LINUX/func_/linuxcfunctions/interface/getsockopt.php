...
<title>getsockopt函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">getsockopt（取得socket状态）<br>
	相关函数 setsockopt<br>
	表头文件 #include&lt;sys/types.h&gt;<br>
	#include&lt;sys/socket.h&gt;<br>
	定义函数 int getsockopt(int s,int level,int optname,void*<br>
	optval,socklen_t* optlen);<br>
	函数说明 getsockopt()会将参数s所指定的socket状态返回。参数optname代表欲取得何种选项状态，而参数optval则指向欲保存结果的内存地址，参数optlen则为该空间的大小。参数level、optname请参考setsockopt()。<br>
	返回值 成功则返回0，若有错误则返回-1，错误原因存于errno<br>
	错误代码 EBADF 参数s 并非合法的socket处理代码<br>
...
<tr><td align="right" width="398"> 
	...
	if((s = socket(AF_INET,SOCK_STREAM,0))&lt;0) perror<br>
	(“socket”);<br>
	getsockopt(s,SOL_SOCKET,SO_TYPE,&amp;optval,&amp;optlen);<br>
	printf(“optval = %d\n”,optval);<br>
	close(s);}<br>
	执行 optval = 1 /*SOCK_STREAM的定义正是此值*/</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="getsockopt.php#" class="bds_more" data-cmd="more"></a>
	<a href="getsockopt.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="getsockopt.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="getsockopt.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="getsockopt.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="getsockopt.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
