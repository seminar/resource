...
<title>inet_ntoa函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">inet_ntoa（将网络二进制的数字转换成网络地址）<br>
	相关函数 inet_addr，inet_aton<br>
	表头文件 #include&lt;sys/socket.h&gt;<br>
	#include&lt;netinet/in.h&gt;<br>
	#include&lt;arpa/inet.h&gt;<br>
	定义函数 char * inet_ntoa(struct in_addr in);<br>
	函数说明 inet_ntoa()用来将参数in所指的网络二进制的数字转换成网络地址，然后将指向此网络地址字符串的指针返回。<br>
	返回值 成功则返回字符串指针，失败则返回NULL。</td>
	</tr>
</table>
　</td>
    <td background="../img_css/frame11.gif" width="14">　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="inet_ntoa.php#" class="bds_more" data-cmd="more"></a>
	<a href="inet_ntoa.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="inet_ntoa.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="inet_ntoa.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="inet_ntoa.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="inet_ntoa.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
