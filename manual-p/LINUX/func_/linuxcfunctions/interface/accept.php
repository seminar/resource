...
<title>accept函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">accept（接受socket连线）<br>
	相关函数 socket，bind，listen，connect<br>
	表头文件 #include&lt;sys/types.h&gt;<br>
	#include&lt;sys/socket.h&gt;<br>
	定义函数 int accept(int s,struct sockaddr * addr,int * addrlen);<br>
	函数说明 accept()用来接受参数s的socket连线。参数s的socket必需先经bind()、listen()函数处理过，当有连线进来时accept()会返回一个新的socket处理代码，往后的数据传送与读取就是经由新的socket处理，而原来参数s的socket能继续使用accept()来接受新的连线要求。连线成功时，参数addr所指的结构会被系统填入远程主<br>
	机的地址数据，参数addrlen为scokaddr的结构长度。关于结构<br>
	sockaddr的定义请参考bind()。<br>
	返回值 成功则返回新的socket处理代码，失败返回-1，错误原因存于errno中。<br>
	错误代码 EBADF 参数s 非合法socket处理代码。<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="accept.php#" class="bds_more" data-cmd="more"></a>
	<a href="accept.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="accept.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="accept.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="accept.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="accept.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
