...
<title>shutdown函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">shutdown（终止socket通信）<br>
	相关函数 socket，connect<br>
	表头文件 #include&lt;sys/socket.h&gt;<br>
	定义函数 int shutdown(int s,int how);<br>
	函数说明 shutdown()用来终止参数s所指定的socket连线。参数s是连线中的<br>
	socket处理代码，参数how有下列几种情况:<br>
	how=0 终止读取操作。<br>
	how=1 终止传送操作<br>
	how=2 终止读取及传送操作<br>
	返回值 成功则返回0，失败返回-1，错误原因存于errno。<br>
	错误代码 EBADF 参数s不是有效的socket处理代码<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="shutdown.php#" class="bds_more" data-cmd="more"></a>
	<a href="shutdown.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="shutdown.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="shutdown.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="shutdown.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="shutdown.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
