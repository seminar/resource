...
<title>htons函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">htons（将16位主机字符顺序转换成网络字符顺序）<br>
	相关函数 htonl，ntohl，ntohs<br>
	表头文件 #include&lt;netinet/in.h&gt;<br>
	定义函数 unsigned short int htons(unsigned short int hostshort);<br>
	函数说明 htons()用来将参数指定的16位hostshort转换成网络字符顺序。<br>
	返回值 返回对应的网络字符顺序。<br>
　</td>
	</tr>
</table>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="htons.php#" class="bds_more" data-cmd="more"></a>
	<a href="htons.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="htons.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="htons.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="htons.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="htons.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
