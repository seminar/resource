...
<title>inet_addr函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">inet_addr（将网络地址转成二进制的数字）<br>
	相关函数 inet_aton，inet_ntoa<br>
	表头文件 #include&lt;sys/socket.h&gt;<br>
	#include&lt;netinet/in.h&gt;<br>
	#include&lt;arpa/inet.h&gt;<br>
	定义函数 unsigned long int inet_addr(const char *cp);<br>
	函数说明 inet_addr()用来将参数cp所指的网络地址字符串转换成网络所使用的二进制数字。网络地址字符串是以数字和点组成的字符串，例如:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; “163.13.132.68”。<br>
	返回值 成功则返回对应的网络二进制的数字，失败返回-1。</td>
	</tr>
</table>
　</td>
    <td background="../img_css/frame11.gif" width="14">　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="inet_addr.php#" class="bds_more" data-cmd="more"></a>
	<a href="inet_addr.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="inet_addr.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="inet_addr.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="inet_addr.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="inet_addr.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
