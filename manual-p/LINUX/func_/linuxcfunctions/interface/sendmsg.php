...
<title>sendmsg函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">sendmsg（经socket传送数据）<br>
	相关函数 send，sendto，recv，recvfrom，recvmsg，socket<br>
	表头文件 #include&lt;sys/types.h&gt;<br>
	#include&lt;sys/socket.h&gt;<br>
	定义函数 int sendmsg(int s,const strcut msghdr *msg,unsigned int flags);<br>
	函数说明 sendmsg()用来将数据由指定的socket传给对方主机。参数s为已建立好连线的socket，如果利用UDP协议则不需经过连线操作。参数msg 
	...
	strcut iovec * msg_iov; /* Vector of data to send/receive<br>
	into */<br>
	...
	返回值 成功则返回实际传送出去的字符数，失败返回-1，错误原因存于errno<br>
	错误代码 EBADF 参数s 非合法的socket处理代码。<br>
	...
	ENOMEM 核心内存不足<br>
	EINVAL 传给系统调用的参数不正确。<p align="left">　</td>
	</tr>
</table>
　</td>
    <td background="../img_css/frame11.gif" width="14">　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="sendmsg.php#" class="bds_more" data-cmd="more"></a>
	<a href="sendmsg.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="sendmsg.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="sendmsg.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="sendmsg.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="sendmsg.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
