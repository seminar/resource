...
<title>setsockopt函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">setsockopt（设置socket状态）<br>
	相关函数 getsockopt<br>
	表头文件 #include&lt;sys/types.h&gt;<br>
	#include&lt;sys/socket.h&gt;<br>
	定义函数 int setsockopt(int s,int level,int optname,const void *<br>
	optval,,socklen_toptlen);<br>
	函数说明 setsockopt()用来设置参数s所指定的socket状态。参数level代表<br>
	欲设置的网络层，一般设成SOL_SOCKET以存取socket层。参数<br>
	optname代表欲设置的选项，有下列几种数值:<br>
	...
	参数 optval代表欲设置的值，参数optlen则为optval的长度。<br>
	返回值 成功则返回0，若有错误则返回-1，错误原因存于errno。<br>
	附加说明 EBADF 参数s并非合法的socket处理代码<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="setsockopt.php#" class="bds_more" data-cmd="more"></a>
	<a href="setsockopt.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="setsockopt.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="setsockopt.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="setsockopt.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="setsockopt.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
