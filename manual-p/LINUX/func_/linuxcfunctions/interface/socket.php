...
<title>socket函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">socket（建立一个socket通信）<br>
	相关函数 accept，bind，connect，listen<br>
	表头文件 #include&lt;sys/types.h&gt;<br>
	#include&lt;sys/socket.h&gt;<br>
	定义函数 int socket(int domain,int type,int protocol);<br>
	函数说明 socket()用来建立一个新的socket，也就是向系统注册，通知系统建立一通信端口。参数domain 
	...
	protocol用来指定socket所使用的传输协议编号，通常此参考不用<br>
	管它，设为0即可。<br>
	返回值 成功则返回socket处理代码，失败返回-1。<br>
	错误代码 EPROTONOSUPPORT 参数domain指定的类型不支持参数type或protocol指定的协议<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="socket.php#" class="bds_more" data-cmd="more"></a>
	<a href="socket.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="socket.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="socket.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="socket.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="socket.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
