...
<title>recvfrom函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">recvfrom（经socket接收数据）<br>
	相关函数 recv，recvmsg，send，sendto，socket<br>
	表头文件 #include&lt;sys/types.h&gt;<br>
	#include&lt;sys/socket.h&gt;<br>
	定义函数 int recvfrom(int s,void *buf,int len,unsigned int flags ,struct 
	sockaddr *from ,int *fromlen);<br>
	函数说明 recv()用来接收远程主机经指定的socket 传来的数据，并把数据存到由参数buf 指向的内存空间，参数len 
	为可接收数据的最大长度。参数flags 一般设0，其他数值定义请参考recv()。参数from用来指定欲传送的网络地址，结构sockaddr 
	请参考bind()。参数fromlen为sockaddr的结构长度。<br>
	返回值 成功则返回接收到的字符数，失败则返回-1，错误原因存于errno中。<br>
	错误代码 EBADF 参数s非合法的socket处理代码<br>
...
<tr><td align="right" width="398"> 
	<p align="left">UDP server 范例请参考sendto（）。<p align="left">范例:<p align="left">
	<br>
	*/<br>
	...
	执行 (先执行udp server 再执行udp client)<br>
	hello /*从键盘输入字符串*/<br>
	receive: hello /*server端返回来的字符串*/</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="recvfrom.php#" class="bds_more" data-cmd="more"></a>
	<a href="recvfrom.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="recvfrom.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="recvfrom.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="recvfrom.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="recvfrom.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
