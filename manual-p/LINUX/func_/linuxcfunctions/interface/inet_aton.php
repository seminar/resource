...
<title>inet_aton函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">inet_aton（将网络地址转成网络二进制的数字）<br>
	相关函数 inet_addr，inet_ntoa<br>
	表头文件 #include&lt;sys/scoket.h&gt;<br>
	#include&lt;netinet/in.h&gt;<br>
	#include&lt;arpa/inet.h&gt;<br>
	定义函数 int inet_aton(const char * cp,struct in_addr *inp);<br>
	函数说明 inet_aton()用来将参数cp所指的网络地址字符串转换成网络使用的二进制的数字，然后存于参数inp所指的in_addr结构中。<br>
	结构in_addr定义如下<br>
	struct in_addr<br>
	{<br>
	&nbsp;&nbsp;&nbsp;
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="inet_aton.php#" class="bds_more" data-cmd="more"></a>
	<a href="inet_aton.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="inet_aton.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="inet_aton.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="inet_aton.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="inet_aton.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
