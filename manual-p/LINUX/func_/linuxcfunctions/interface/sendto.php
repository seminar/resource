...
<title>sendto函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">sendto（经socket传送数据）<br>
	相关函数 send , sendmsg,recv , recvfrom , socket<br>
	表头文件&nbsp; #include &lt; sys/types.h &gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; #include &lt; sys/socket.h &gt;<br>
	定义函数 int sendto ( int s , const void * msg, int len, unsigned int flags, 
	const struct sockaddr * to , int tolen ) ;<br>
	...
	返回值 成功则返回实际传送出去的字符数，失败返回－1，错误原因存于errno 中。<br>
	错误代码 EBADF 参数s非法的socket处理代码。<br>
...
<tr><td align="right" width="398"> 
	...
	len = recvfrom(socket,buffer,sizeof(buffer), 0 , &amp;addr<br>
	&amp;addr_len);<br>
	/*显示client端的网络地址*/<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="sendto.php#" class="bds_more" data-cmd="more"></a>
	<a href="sendto.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="sendto.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="sendto.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="sendto.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="sendto.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
