...
<title>ntohl函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">ntohl（将32位网络字符顺序转换成主机字符顺序）<br>
	相关函数 htonl，htons，ntohs<br>
	表头文件 #include&lt;netinet/in.h&gt;<br>
	定义函数 unsigned long int ntohl(unsigned long int netlong);<br>
	函数说明 ntohl()用来将参数指定的32位netlong转换成主机字符顺序。<br>
	返回值 返回对应的主机字符顺序。<br>
　</td>
	</tr>
</table>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="ntohl.php#" class="bds_more" data-cmd="more"></a>
	<a href="ntohl.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="ntohl.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="ntohl.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="ntohl.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="ntohl.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
