...
<title>send函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">send（经socket传送数据）<br>
	相关函数 sendto，sendmsg，recv，recvfrom，socket<br>
	表头文件 #include&lt;sys/types.h&gt;<br>
	#include&lt;sys/socket.h&gt;<br>
	定义函数 int send(int s,const void * msg,int len,unsigned int falgs);<br>
	函数说明 send()用来将数据由指定的socket 传给对方主机。参数s为已建立好连接的socket。参数msg指向欲连线的数据内容，参数len则为数据长度。参数flags一般设0，其他数值定义如下<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="send.php#" class="bds_more" data-cmd="more"></a>
	<a href="send.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="send.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="send.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="send.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="send.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
