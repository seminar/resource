...
<title>setservent函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">setservent（打开主机网络服务的数据文件）<br>
	相关函数 getservent, getservbyname, getservbyport, endservent<br>
	表头文件 #include &lt; netdb.h &gt;<br>
	定义函数 void setservent (int stayopen);<br>
	函数说明 setservent()用来打开/etc/services，如果参数stayopen值为1，则接下来的getservbyname()或getservbyport()将补回自动关闭文件。<br>
	　</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="setservent.php#" class="bds_more" data-cmd="more"></a>
	<a href="setservent.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="setservent.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="setservent.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="setservent.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="setservent.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
