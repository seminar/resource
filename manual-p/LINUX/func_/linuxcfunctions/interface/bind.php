...
<title>bind函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">bind（对socket定位）<br>
	相关函数 socket，accept，connect，listen<br>
	表头文件 #include&lt;sys/types.h&gt;<br>
	#include&lt;sys/socket.h&gt;<br>
	定义函数 int bind(int sockfd,struct sockaddr * my_addr,int addrlen);<br>
	函数说明 bind()用来设置给参数sockfd的socket一个名称。此名称由参数my_addr指向一sockaddr结构，对于不同的socket 
	...
	此sockaddr结构会因使用不同的socket domain而有不同结构定义，<br>
	例如使用AF_INET domain，其socketaddr结构定义便为<br>
	...
	sin_zero 未使用。<br>
	参数 addrlen为sockaddr的结构长度。<br>
	返回值 成功则返回0，失败返回-1，错误原因存于errno中。<br>
	错误代码 EBADF 参数sockfd 非合法socket处理代码。<br>
	EACCESS 权限不足<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="bind.php#" class="bds_more" data-cmd="more"></a>
	<a href="bind.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="bind.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="bind.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="bind.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="bind.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
