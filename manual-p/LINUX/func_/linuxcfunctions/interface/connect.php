...
<title>connect函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">connect（建立socket连线）<br>
	相关函数 socket，bind，listen<br>
	表头文件 #include&lt;sys/types.h&gt;<br>
	#include&lt;sys/socket.h&gt;<br>
	定义函数 int connect (int sockfd,struct sockaddr * serv_addr,int addrlen);<br>
	函数说明 connect()用来将参数sockfd 的socket 连至参数serv_addr 指定的网络地址。结构sockaddr请参考bind()。参数addrlen为sockaddr的结构长度。<br>
...
<tr><td align="right" width="398"> 
	<p align="left">范例:</p>
	<p align="left">/* 利用socket的TCP client<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="connect.php#" class="bds_more" data-cmd="more"></a>
	<a href="connect.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="connect.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="connect.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="connect.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="connect.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
