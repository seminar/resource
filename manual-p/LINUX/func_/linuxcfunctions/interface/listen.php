...
<title>listen函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<li><a href="bind.php">bind</a></li>
<li><a href="connect.php">connect</a></li>
<li><a href="endprotoent.php">endprotoent</a></li>
<li><a href="endservent.php">endservent</a></li>
<li><a href="getsockopt.php">getsockopt</a></li>
<li><a href="htonl.php">atan2</a></li>
<li><a href="htons.php">htons</a></li>
<li><a href="inet_addr.php">inet_addr</a></li>
<li><a href="inet_aton.php">inet_aton</a></li>
<li><a href="inet_ntoa.php">inet_ntoa</a></li>
<li><a href="listen.php">listen</a></li>
<li><a href="ntohl.php">ntohl</a></li>
<li><a href="ntohs.php">ntohs</a></li>
<li><a href="recv.php">recv</a></li>
<li><a href="recvfrom.php">recvfrom</a></li>
<li><a href="recvmsg.php">recvmsg</a></li>
<li><a href="send.php">send</a></li>
<li><a href="sendmsg.php">sendmsg</a></li>
<li><a href="sendto.php">sendto</a></li>
<li><a href="setprotoent.php">setprotoent</a></li>
<li><a href="setservent.php">setservent</a></li>
<li><a href="setsockopt.php">setsockopt</a></li>
<li><a href="shutdown.php">shutdown</a></li>
<li><a href="socket.php">socket</a></li>
</ul>
  <h3>文件处理函数 </h3>
  <ul>
...
<tr><td align="right" width="398"> 
	<p align="left">listen（等待连接）<br>
	相关函数 socket，bind，accept，connect<br>
	表头文件 #include&lt;sys/socket.h&gt;<br>
	定义函数 int listen(int s,int backlog);<br>
	函数说明 listen()用来等待参数s 的socket连线。参数backlog指定同时能处<br>
	理的最大连接要求，如果连接数目达此上限则client端将收到<br>
	ECONNREFUSED的错误。Listen()并未开始接收连线，只是设置<br>
	socket为listen模式，真正接收client端连线的是accept()。通常<br>
	listen()会在socket()，bind()之后调用，接着才调用accept()。<br>
	返回值 成功则返回0，失败返回-1，错误原因存于errno<br>
	附加说明 listen()只适用SOCK_STREAM或SOCK_SEQPACKET的socket类型。如果socket为AF_INET则参数backlog 
	最大值可设至128。<br>
	错误代码 EBADF 参数sockfd非合法socket处理代码<br>
	EACCESS 权限不足<br>
...
<tr><td align="right" width="398"> 
	<p align="left">范例:</p>
	<p align="left">#include&lt;sys/types.h&gt;<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="listen.php#" class="bds_more" data-cmd="more"></a>
	<a href="listen.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="listen.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="listen.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="listen.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="listen.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
