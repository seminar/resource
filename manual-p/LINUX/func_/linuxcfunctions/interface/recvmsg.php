...
<title>recvmsg函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="397"> 
	<p align="left">recvmsg（经socket接收数据）<br>
	相关函数 recv，recvfrom，send，sendto，sendmsg，socket<br>
	表头文件 #include&lt;sys/types.h&gt;<br>
	#include&lt;sys/socktet.h&gt;<br>
	定义函数 int recvmsg(int s,struct msghdr *msg,unsigned int flags);<br>
	函数说明 recvmsg()用来接收远程主机经指定的socket传来的数据。参数s为已建立好连线的socket，如果利用UDP协议则不需经过连线操作。参数msg指向欲连线的数据结构内容，参数flags一般设0，详细描述请参考send()。关于结构msghdr的定义请参考sendmsg()。<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="recvmsg.php#" class="bds_more" data-cmd="more"></a>
	<a href="recvmsg.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="recvmsg.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="recvmsg.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="recvmsg.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="recvmsg.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
