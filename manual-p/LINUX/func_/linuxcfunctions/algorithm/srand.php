...
<title>srand函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">srand（设置随机数种子）<br>
	相关函数 rand，random srandom<br>
	表头文件 #include&lt;stdlib.h&gt;<br>
	定义函数 void srand (unsigned int seed);<br>
	函数说明 srand()用来设置rand()产生随机数时的随机数种子。参数seed必须是个整数，通常可以利用geypid()或time(0)的返回值来当做seed。<br>
	如果每次seed都设相同值，rand()所产生的随机数值每次就会一<br>
	样。<br>
	返回值<br>
　</td>
	</tr>
...
<tr><td align="right" width="398"> 
	<p align="left">范例:</p>
	<p align="left">　</p>
	<p align="left">/* 产生介于1 到10 间的随机数值，此范例与执行结果可与rand（）参照*/<br>
	#include&lt;time.h&gt;<br>
	#include&lt;stdlib.h&gt;<br>
	main()<br>
	{<br>
	...
	执行 5 8 8 8 10 2 10 8 9 9<br>
	2 9 7 4 10 3 2 10 8 7</p></td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="srand.php#" class="bds_more" data-cmd="more"></a>
	<a href="srand.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="srand.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="srand.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="srand.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="srand.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
