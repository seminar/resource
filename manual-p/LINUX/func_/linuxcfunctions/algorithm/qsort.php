...
<title>qsort函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">qsort（利用快速排序法排列数组）<br>
	相关函数 bsearch<br>
	表头文件 #include&lt;stdlib.h&gt;<br>
	定义函数 void qsort(void * base,size_t nmemb,size_t size,int ( *<br>
	compar)(const void *, const void *));<br>
	函数说明 参数base指向欲排序的数组开头地址，参数nmemb代表数组中的元素数量，每一元素的大小则由参数size决定，最后一项参数compar为一函数指针，这个函数用来判断两个元素间的大小关系，若传给compar的第一个参数所指的元素数据大于第二个参数所指的元素数据则必须回传大于零的值，两个元素数据相等则回传0。<br>
	返回值<br>
	附加说明<br>
　</td>
	</tr>
...
<tr><td align="right" width="398"> 
	<p align="left">范例:</p>
	<p align="left">#define nmemb 7<br>
	#include &lt;stdlib.h&gt;<br>
	...
	执行 3 102 5 -2 98 52 18<br>
	-2 3 5 18 52 98 102</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="qsort.php#" class="bds_more" data-cmd="more"></a>
	<a href="qsort.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="qsort.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="qsort.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="qsort.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="qsort.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
