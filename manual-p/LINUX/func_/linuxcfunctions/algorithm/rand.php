...
<title>rand函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">rand（产生随机数）<br>
	相关函数 srand，random，srandom<br>
	表头文件 #include&lt;stdlib.h&gt;<br>
	定义函数 int rand(void)<br>
	函数说明 rand()会返回一随机数值，范围在0至RAND_MAX 间。在调用此函数产生随机数前，必须先利用srand()设好随机数种子，如果未设随机数种子，rand()在调用时会自动设随机数种子为1。关于随机数种子请参考srand()。<br>
	返回值 返回0至RAND_MAX之间的随机数值，RAND_MAX定义在stdlib.h，其值为2147483647。<br>
　</td>
	</tr>
</table>
　</td>
...
<tr><td align="right" width="398"> 
	<p align="left">范例:</p>
	<p align="left">/* 产生介于1 到10 间的随机数值，此范例未设随机数种子，完整的随机数产生请参考srand（）*/<br>
	#include&lt;stdlib.h&gt;<br>
	main()<br>
	{<br>
	int i,j;<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="rand.php#" class="bds_more" data-cmd="more"></a>
	<a href="rand.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="rand.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="rand.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="rand.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="rand.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
