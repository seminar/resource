...
<title>lsearch函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<li><a href="../filecontent/ungetc.php">ungetc</a></li>
  ...
  <h3>数据结构和算法 </h3>
  <ul>
<li><a href="bsearch.php">bsearch</a></li>
<li><a href="crypt.php">crypt</a></li>
<li><a href="lfind.php">lfind</a></li>
<li><a href="lsearch.php">lsearch</a></li>
<li><a href="qsort.php">qsort</a></li>
<li><a href="rand.php">rand</a></li>
<li><a href="srand.php">srand</a></li>
</ul>
  <h3>内存和字符串函数</h3>
  <ul>
...
<tr><td align="right" width="411"> 
	<p align="left">lsearch（线性搜索）<br>
	相关函数 lfind<br>
	表头文件 #include&lt;stdlib.h&gt;<br>
	定义函数 void *lsearch(const void * key ,const void * base ,size_t *<br>
	nmemb,size_t size, int ( * compar) (const void * ,const<br>
	void *));<br>
	函数说明 lsearch()利用线性搜索在数组中从头至尾一项项查找数据。参数key指向欲查找的关键数据，参数base指向要被搜索的数组开头地址，参数nmemb 
	代表数组中的元素数量，每一元素的大小则由参数size 决定，最后一项参数compar 为一函数指针，这个函数用来判断两个元素是否相同，若传给compar 
	的第一个参数所指的元素数据和第二个参数所指的元素数据相同时则返回0，两个元素数据不相同则返回非0 值。如果lsearch（）找不到关键数据时会主动把该项数据加入数组里。<br>
	返回值 找到关键数据则返回找到的该笔元素的四肢，如果在数组中找不到关键数据则将此关键数据加入数组，再把加入数组后的地址返回。<br>
　</td>
	</tr>
</table>
　</td>
...
<tr><td align="right" width="398"> 
	...
	main()<br>
	{<br>
	char data[NMEMB][SIZE]={“Linux”,”freebsd”,”<br>
	solzris”,”sunos”,”windows”};<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="lsearch.php#" class="bds_more" data-cmd="more"></a>
	<a href="lsearch.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="lsearch.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="lsearch.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="lsearch.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="lsearch.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
