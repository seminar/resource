...
<title>bsearch函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<img border="0" src="../img_css/line.JPG" width="406" height="7"></div>
  ...
  <tr> 
    <td background="../img_css/frame10.gif" width="12">　</td>
    <td>
<table width="416" border="0" align="center" class="space" id="table35">
<tr><td align="right" width="410"> 
	<p align="left">bsearch（二元搜索）<br>
	相关函数 qsort<br>
	表头文件 #include&lt;stdlib.h&gt;<br>
	定义函数 void *bsearch(const void *key,const void *base,size_t<br>
	nmemb,size_tsize,int (*compar) (const void*,const void*));<br>
	函数说明 bsearch()利用二元搜索从排序好的数组中查找数据。参数key指向欲查找的关键数据，参数base指向要被搜索的数组开头地址，参数nmemb 
	...
	附加说明 找到关键数据则返回找到的地址，如果在数组中找不到关键数据则返回NULL。<br>
　</td>
	</tr>
</table>
　</td>
...
<tr><td align="right" width="398"> 
	...
	main()<br>
	{<br>
	char data[50][size]={“linux”,”freebsd”,”solaris”,”<br>
	sunos”,”windows”};<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="bsearch.php#" class="bds_more" data-cmd="more"></a>
	<a href="bsearch.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="bsearch.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="bsearch.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="bsearch.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="bsearch.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
