...
<title>free函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">free（释放原先配置的内存）<br>
	相关函数 malloc，calloc，realloc，brk<br>
	表头文件 #include&lt;stdlib.h&gt;<br>
	定义函数 void free(void *ptr);<br>
	函数说明 参数ptr为指向先前由malloc()、calloc()或realloc()所返回的内存指针。调用free()后ptr所指的内存空间便会被收回。假若参数ptr所指的内存空间已被收回或是未知的内存地址，则调用free()可能会有无法预期的情况发生。若参数ptr为NULL，则free()不会有任何作用。</td>
	</tr>
</table>
　</td>
    <td background="../img_css/frame11.gif" width="14">　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="free.php#" class="bds_more" data-cmd="more"></a>
	<a href="free.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="free.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="free.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="free.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="free.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
