...
<title>malloc函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">malloc（配置内存空间）<br>
	相关函数 calloc，free，realloc，brk<br>
	表头文件 #include&lt;stdlib.h&gt;<br>
	定义函数 void * malloc(size_t size);<br>
	函数说明 malloc()用来配置内存空间，其大小由指定的size决定。<br>
	返回值 若配置成功则返回一指针，失败则返回NULL。<br>
	范例 void p = malloc(1024); /*配置1k的内存*/</td>
	</tr>
</table>
　</td>
    <td background="../img_css/frame11.gif" width="14">　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="malloc.php#" class="bds_more" data-cmd="more"></a>
	<a href="malloc.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="malloc.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="malloc.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="malloc.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="malloc.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
