...
<title>calloc函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">calloc（配置内存空间）<br>
	相关函数 malloc，free，realloc，brk<br>
	表头文件 #include &lt;stdlib.h&gt;<br>
	定义函数 void *calloc(size_t nmemb，size_t size);<br>
	函数说明 calloc()用来配置nmemb个相邻的内存单位，每一单位的大小为size，并返回指向第一个元素的指针。这和使用下列的方式效果相同:malloc(nmemb*size);不过，在利用calloc()配置内存时会将内存内容初始化为0。<br>
	返回值 若配置成功则返回一指针，失败则返回NULL。<br>
　</td>
	</tr>
</table>
　</td>
...
<tr><td align="right" width="398"> 
	<p align="left">范例:</p>
	<p align="left">/* 动态配置10个struct test 空间*/<br>
	#include&lt;stdlib.h&gt;<br>
	struct test<br>
	{<br>
	int a[10];<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="calloc.php#" class="bds_more" data-cmd="more"></a>
	<a href="calloc.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="calloc.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="calloc.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="calloc.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="calloc.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
