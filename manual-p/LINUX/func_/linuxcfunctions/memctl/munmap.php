...
<title>munmap函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">munmap（解除内存映射）<br>
	相关函数 mmap<br>
	表头文件 #include&lt;unistd.h&gt;<br>
	#include&lt;sys/mman.h&gt;<br>
	定义函数 int munmap(void *start,size_t length);<br>
	函数说明 munmap()用来取消参数start所指的映射内存起始地址，参数length则是欲取消的内存大小。当进程结束或利用exec相关函数来执行其他程序时，映射内存会自动解除，但关闭对应的文件描述词时不会解除映射。<br>
	返回值 如果解除映射成功则返回0，否则返回－1，错误原因存于errno中错误代码EINVAL<br>
	参数 start或length 不合法。<br>
	　</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="munmap.php#" class="bds_more" data-cmd="more"></a>
	<a href="munmap.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="munmap.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="munmap.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="munmap.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="munmap.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
