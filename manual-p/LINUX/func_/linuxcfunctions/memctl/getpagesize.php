...
<title>getpagesize函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">getpagesize（取得内存分页大小）<br>
	相关函数 sbrk<br>
	表头文件 #include&lt;unistd.h&gt;<br>
	定义函数 size_t getpagesize(void);<br>
	函数说明 返回一分页的大小，单位为字节（byte）。此为系统的分页大小，不一定会和硬件分页大小相同。<br>
	返回值 内存分页大小。附加说明在Intel x86 上其返回值应为4096bytes。<br>
　</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="getpagesize.php#" class="bds_more" data-cmd="more"></a>
	<a href="getpagesize.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="getpagesize.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="getpagesize.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="getpagesize.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="getpagesize.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
