...
<title>putenv函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">putenv（改变或增加环境变量）<br>
	相关函数 getenv，setenv，unsetenv<br>
	表头文件 #include4&lt;stdlib.h&gt;<br>
	定义函数 int putenv(const char * string);<br>
	函数说明 putenv()用来改变或增加环境变量的内容。参数string的格式为<br>
	name＝value，如果该环境变量原先存在，则变量内容会依参数<br>
	string改变，否则此参数内容会成为新的环境变量。<br>
	返回值 执行成功则返回0，有错误发生则返回-1。<br>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="putenv.php#" class="bds_more" data-cmd="more"></a>
	<a href="putenv.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="putenv.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="putenv.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="putenv.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="putenv.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
