...
<title>getenv函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<tr><td align="right" width="398"> 
	<p align="left">getenv（取得环境变量内容）<br>
	相关函数 putenv，setenv，unsetenv<br>
	表头文件 #include&lt;stdlib.h&gt;<br>
	定义函数 char * getenv(const char *name);<br>
	函数说明 getenv()用来取得参数name环境变量的内容。参数name为环境变量<br>
	的名称，如果该变量存在则会返回指向该内容的指针。环境变量的<br>
	格式为name＝value。<br>
	返回值 执行成功则返回指向该内容的指针，找不到符合的环境变量名称则<br>
	返回NULL。<br>
　</td>
	</tr>
</table>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="getenv.php#" class="bds_more" data-cmd="more"></a>
	<a href="getenv.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="getenv.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="getenv.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="getenv.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="getenv.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
