...
<title>setenv函数_Linux C 中文函数手册_Linux编程_linux_操作系统__www.iteedu.com</title>
...
<li><a href="../datetime/time.php">time</a></li>
  ...
  <h3>环境变量函数 </h3>
  <ul>
<li><a href="getenv.php">getenv</a></li>
<li><a href="putenv.php">putenv</a></li>
<li><a href="setenv.php">setenv</a></li>
</ul>
  <h3>终端控制函数 </h3>
  <ul>
...
<tr><td align="right" width="398"> 
	<p align="left">setenv（改变或增加环境变量）<br>
	相关函数 getenv，putenv，unsetenv<br>
	表头文件 #include&lt;stdlib.h&gt;<br>
	定义函数 int setenv(const char *name,const char * value,int<br>
	overwrite);<br>
	函数说明 setenv()用来改变或增加环境变量的内容。参数name为环境变量名<br>
	称字符串。<br>
	参数 value则为变量内容，参数overwrite用来决定是否要改变已存在的<br>
	环境变量。如果overwrite不为0，而该环境变量原已有内容，则原<br>
	内容会被改为参数value所指的变量内容。如果overwrite为0，且该<br>
	环境变量已有内容，则参数value会被忽略。<br>
	返回值 执行成功则返回0，有错误发生时返回-1。<br>
	错误代码 ENOMEM 内存不足，无法配置新的环境变量空间<br>
　</td>
	</tr>
</table>
　</td>
...
﻿<div style="float:right;margin-right:100px;" class="bdsharebuttonbox">
	<a href="setenv.php#" class="bds_more" data-cmd="more"></a>
	<a href="setenv.php#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a>
	<a href="setenv.php#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a>
	<a href="setenv.php#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a>
	<a href="setenv.php#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a>
	<a href="setenv.php#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a>
</div>
<div style="clear:both;"></div>
</div></div>
<!--end of file-wrpper-->
