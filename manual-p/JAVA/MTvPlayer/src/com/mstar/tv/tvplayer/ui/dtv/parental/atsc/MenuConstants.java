...
public class MenuConstants {
    ...
    public static final String VCHIPPASSWORD = "VCHIPPASSWORD";

    public static final String VCHIPPASSWORD_DEFAULTVALUE = "000000";

    public static final String VCHIPBUTTONLOCK = "VCHIPBUTTONLOCK";

    public static final int VCHIPBUTTONLOCK_DEFAULTVALUE = 0;
    ...
    public static String getSharedPreferencesValue(Context context, String item, String defaultValue) {

        SharedPreferences sharedPreferences = context.getSharedPreferences(SHARE_PRES_TITLE,
                Context.MODE_PRIVATE);
        String sharePreValue = sharedPreferences.getString(item, defaultValue);
        return sharePreValue;
    }

    public static void setSharedPreferencesValue(Context context, String item, String value) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(SHARE_PRES_TITLE,
                Context.MODE_PRIVATE);
        Editor edit = sharedPreferences.edit();
        edit.putString(item, value);
        edit.commit();
    }
