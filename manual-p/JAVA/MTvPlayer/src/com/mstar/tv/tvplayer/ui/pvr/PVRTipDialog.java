...
public class PVRTipDialog extends AlertDialog {

    protected PVRTipDialog(Context context) {
        super(context);
    ...
    private Button standyRecording;
    ...
    public static boolean isPVRTipShowing = false;

    @Override
    public void show() {
        // TODO Auto-generated method stub
        super.show();
        isPVRTipShowing = true;
    }
    ...
    protected void onCreate(android.os.Bundle savedInstanceState) {
        ...
        standyRecording = (Button) findViewById(R.id.StandyBy);
        ...
        standyRecording.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {
                try {
                    mPvrManager.setIsBootByRecord(true);
                    ...
                    if (!PVRActivity.isPVRActivityActive) {
                        Toast.makeText(context, "jump to pvr activity", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(context, RootActivity.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                        intent.putExtra("isPVRStandby", true);
