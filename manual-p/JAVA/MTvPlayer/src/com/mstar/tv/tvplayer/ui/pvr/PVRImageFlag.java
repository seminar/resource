...
public class PVRImageFlag {
    ...
    private boolean fowardFlag = false;
    ...
    public void setFfFlag(boolean ffFlag) {
        this.ffFlag = ffFlag;
    }

    public boolean isRevFlag() {
        return revFlag;
    }
    ...
    public boolean isFowardFlag() {
        return fowardFlag;
    }

    public void setFowardFlag(boolean fowardFlag) {
