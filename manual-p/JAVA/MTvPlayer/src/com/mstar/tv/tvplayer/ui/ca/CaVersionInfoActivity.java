...
public class CaVersionInfoActivity extends Activity {
    ...
    protected Handler handler = new Handler() {
        ...
        public void handleMessage(android.os.Message msg) {
            ...
            if (msg.what == LittleDownTimer.TIME_OUT_MSG) {
                ...
                Intent intent = new Intent(CaVersionInfoActivity.this, RootActivity.class);
    ...
    protected void onResume() {
        Log.d("TvApp", "CaVersionInfoActivity onResume");
    ...
    protected void onPause() {
        Log.d("TvApp", "CaVersionInfoActivity onPause");
    ...
    public void onUserInteraction() {
        Log.d("TvApp", "CaVersionInfoActivity onUserInteraction");
    ...
    private void getInitData() {
        CACardSNInfo snInfo = tvCaManager.CaGetCardSN();
        if (snInfo != null && snInfo.sCardState == 0) {
            cardSN = snInfo.pcardsn;
        }
        int caVer = tvCaManager.CaGetVer();
        short stbPlatformId = tvCaManager.CaGetPlatformID();

        textview_ca_version_id.setText("0x" + Integer.toHexString(caVer).toUpperCase());
        textview_ca_version_stb_num.setText(String.valueOf(stbPlatformId));
