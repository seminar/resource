...
abstract class BaseActivity extends Activity {
    ...
    protected Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            if (msg.what == MenuConstants.DELAYFINIFH)
                finish();
     ...
     * @param resultVaule
     */
    abstract void callBack(int resultVaule);

    /**
     * If the type is boolean,call back the value refresh the UI and call
     * tv_service.
     *
     * @param resultVaule
     */
    abstract void callBack(Boolean resultVaule);
