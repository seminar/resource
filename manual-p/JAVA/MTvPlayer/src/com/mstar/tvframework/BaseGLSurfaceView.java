 ...
 *
 */
public class BaseGLSurfaceView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    /**
    /**
     * Inform the view that the activity is started.
     * Do nothing now
    */
    public void onStart() {
    ...
    /**
     * Inform the view that the activity is sStopped.
     * Do nothing now
    */
    public void onStop() {
    ...
    public void onResume() {
        //Log.i(TAG, " ======================  BaseGLSurface view  onResume ~~~~~~~~~~~\n");
        mGLThread.onResume();
    }
                    ...
                    synchronized (sGLThreadManager) {
                        while (true) {
                            ...
                            if (mFreezed != mRequestFreezed) {
                                ...
                                sGLThreadManager.notifyAll();
                                if (LOG_PAUSE_RESUME) {
                                    Log.i("GLThread", "mFreezed is now " + mFreezed + " tid=" + getId());
                                }
                            }
                            ...
                            if (readyToDraw()) {
                                ...
                                if (mHaveEglSurface && !mSurfaceFailedNeedWait) {
                                    ...
                                    if(mSurfaceFailedNeedWait) {
                                        ...
                                        mSurfaceFailedNeedWait = false;
                                        mWaitingForSurface = true;
                                        Log.i("GLThread", "wait here until create surface");
                                        sGLThreadManager.notifyAll();
                                    }
                                }
                            }
                            ...
                            if (LOG_THREADS) {
                                Log.i("GLThread", "waiting tid=" + getId()
                                    ...
                                    + " mFreezed: "+ mFreezed
                                    + " mSurfaceFailedOnce: "+ mSurfaceFailedOnce);
                            }
