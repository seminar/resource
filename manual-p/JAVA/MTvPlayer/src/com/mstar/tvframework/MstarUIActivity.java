...
//        System.loadLibrary("ogrekit_ui_jni");
    ...
    @Override
    public native boolean axisEvent(int coordType, int btnType, int action, float x, float y, MotionEvent event);

    @Override
    public native boolean runLuaScript(String Script);

    @Override
    public native boolean setImage(Bitmap image, String appName, String sceneName, String objName, int subEntityID,
    ...
    public void callBackSceneChange(String OldSceneName, String NewSceneName) {
        Log.v(TAG, "callBackSceneChange OldSceneName" + OldSceneName + " NewSceneName" + NewSceneName);
    }

    @Override
    public void callBackBlendFileChange(String OldFileName, String NewFileName) {
        Log.v(TAG, "callBackBlendFileChange OldFileName" + OldFileName + " NewFileName" + NewFileName);
    }
    ...
    public native boolean registerAnimToListen(String SceneName, String OldObjName, String NewObjName);

    public native boolean unRegisterListenAnim(String SceneName, String OldObjName, String NewObjName);

    @Override
    public native void createDynamicTexture(int width, int height, int num_mips, String pixelFormat, String name,
    ...
    @Override
    public native boolean replacewithDynamicTex(String appName, String sceneName, String objName, int subEntityID,
            int techID, int passID, int stateID);
